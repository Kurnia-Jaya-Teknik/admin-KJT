        ...
        .then(res => {
            ...
            if (d.status === 'Permintaan Surat') {
                ...
                actionsHtml = `
                    ...
                    <button type="button" onclick="approveMagang(${d.id})" class="flex items-center justify-center gap-2 px-8 py-3 bg-gradient-to-r from-green-500 to-green-400 text-white font-semibold rounded-2xl hover:from-green-600 hover:to-green-500 shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                        </svg>
                        Approve
                    </button>
                    <button type="button" onclick="rejectMagang(${d.id})" class="flex items-center justify-center gap-2 px-8 py-3 bg-gradient-to-r from-red-500 to-red-400 text-white font-semibold rounded-2xl hover:from-red-600 hover:to-red-500 shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
    ...
    fetch(`/admin/magang/${magangId}/buat-surat`, { 
        ...
        .then(res => {
            ...
            setTimeout(() => {
                ...
                // Reload halaman setelah 2 detik agar status berubah ke Surat Selesai
                setTimeout(() => {
                    location.reload();
                }, 2000);
            }, 100);
