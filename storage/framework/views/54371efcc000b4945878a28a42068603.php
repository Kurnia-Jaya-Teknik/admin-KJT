                        ...
                        <div
                            ...
                            <div class="relative">
                                        ...
                                        <div
                                            ...
                                            <div class="absolute bottom-full mb-2 hidden group-hover/bar:block z-10">
                                                <div
                                                    ...
                                                    <div class="font-semibold"><?php echo e($entry['label']); ?></div>
                                                    <div class="text-gray-300"><?php echo e($entry['count']); ?> pengajuan</div>
                                                </div>
                                            </div>
                                            <!-- Bar -->
                                            <div class="w-full bg-gradient-to-t from-<?php echo e($color); ?>-400 to-<?php echo e($color); ?>-300 rounded-t-xl shadow-md hover:shadow-lg hover:from-<?php echo e($color); ?>-500 hover:to-<?php echo e($color); ?>-400 transition-all duration-300 cursor-pointer relative"
                                                style="height: <?php echo e($heightPx); ?>px;">
                                                <!-- Count badge on bar -->
                                                <div
                                                    class="absolute top-2 left-1/2 -translate-x-1/2 bg-white/90 text-<?php echo e($color); ?>-700 text-xs font-bold px-2 py-0.5 rounded-full shadow">
                                            ...
                                            <!-- Label -->
                                            <span
                                                class="text-[10px] text-gray-600 font-medium mt-1 text-center leading-tight"><?php echo e($entry['label']); ?></span>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                ...
                                <div class="pt-4 border-t border-gray-100/30 flex items-center justify-between mt-4">
                                    <span class="text-sm font-medium text-gray-600">Total 6 Bulan</span>
                                    <span
                                        class="text-lg font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"><?php echo e($totalPengajuan6); ?>
                        ...
                        <div
                            ...
                            <div class="space-y-2">
                                <div class="text-xs text-gray-600 leading-relaxed">
                                    ...
                                    <p class="text-gray-500"><?php echo e($hadirHariIni ?? 0); ?> dari <?php echo e($totalKaryawan ?? 0); ?>
                                ...
                                <div class="text-xs text-gray-600 leading-relaxed pt-2 border-t border-red-100/50">
                                    ...
                                    <p class="text-gray-500"><?php echo e($pendingApprovals ?? 0); ?> pengajuan memerlukan
                                        tindakan</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="divide-gray-100 max-h-96 overflow-y-auto">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $cutiList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                    $color = $colors[$index % count($colors)];
                                ...
                                <div class="px-6 py-4 hover:bg-gray-50 transition-colors">
                                    <div class="flex items-start gap-4">
                                        <div
                                            class="w-10 h-10 rounded-full bg-<?php echo e($color); ?>-100 flex items-center justify-center flex-shrink-0 font-semibold text-<?php echo e($color); ?>-600">
                                            <?php echo e($initials); ?>

                                        </div>
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-center justify-between mb-1">
                                                <p class="text-sm font-semibold text-gray-800"><?php echo e($item['nama']); ?></p>
                                                <span
                                                    class="text-xs px-2 py-0.5 rounded-full font-medium bg-yellow-100 text-yellow-800">Pending</span>
                                            </div>
                                            <p class="text-xs text-gray-500 mb-1"><?php echo e($item['jenis']); ?></p>
                                            <p class="text-xs font-medium text-gray-700"><?php echo e($item['durasi']); ?> •
                                                <?php echo e($item['tanggal']); ?></p>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="divide-gray-100 max-h-96 overflow-y-auto">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $lemburList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                    $color = $colors[$index % count($colors)];
                                    $initials = collect(explode(' ', $item['nama']))
                                        ->map(fn($n) => substr($n, 0, 1))
                                ...
                                <div class="px-6 py-4 hover:bg-gray-50 transition-colors">
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-center justify-between mb-1">
                                                <p class="text-sm font-semibold text-gray-800"><?php echo e($item['nama']); ?>
                ...
                <div class="grid grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="divide-gray-100 max-h-80 overflow-y-auto">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $karyawanPerluPerhatian ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $karyawan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                    $colors = ['indigo', 'blue', 'green', 'orange', 'red', 'purple', 'pink', 'yellow'];
                                ...
                                <div class="px-6 py-4 hover:bg-gray-50 transition-colors">
                                    <div class="flex items-start gap-4">
                                        <div
                                            class="w-10 h-10 rounded-full bg-<?php echo e($color); ?>-100 flex items-center justify-center flex-shrink-0 font-semibold text-<?php echo e($color); ?>-600">
                                            <?php echo e($initials); ?></div>
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-center justify-between mb-1">
                                                <p class="text-sm font-semibold text-gray-800">
                                                    <?php echo e($karyawan['nama']); ?></p>
                                                <span
                                                    class="text-xs px-2 py-0.5 rounded-full font-medium bg-<?php echo e($color); ?>-100 text-<?php echo e($color); ?>-800"><?php echo e($karyawan['badge']); ?></span>
                                            </div>
                                            <p class="text-xs text-gray-500 mb-1"><?php echo e($karyawan['departemen']); ?></p>
                                            <p class="text-xs font-medium text-gray-700">
                                                <?php echo e($karyawan['keterangan']); ?></p>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span
                                class="text-xs font-medium text-gray-500 bg-white/60 px-2 py-1 rounded-full"><?php echo e(count($aktivitasTerbaru ?? [])); ?>
                    ...
                    <div class="divide-y divide-gray-100/50">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $aktivitasTerbaru ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aktivitas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div
                                class="px-6 py-5 hover:bg-gradient-to-r hover:from-<?php echo e($aktivitas['color']); ?>-50/30 hover:to-transparent transition-all duration-300 group">
                                <div class="flex items-start gap-4">
                                    <div
                                        class="w-12 h-12 rounded-xl bg-gradient-to-br from-<?php echo e($aktivitas['color']); ?>-100 to-<?php echo e($aktivitas['color']); ?>-50 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300 shadow-sm">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($aktivitas['icon'] === 'check'): ?>
                                            <svg class="w-6 h-6 text-<?php echo e($aktivitas['color']); ?>-600" fill="none"
                                                stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                        <?php elseif($aktivitas['icon'] === 'clock'): ?>
                                            <svg class="w-6 h-6 text-<?php echo e($aktivitas['color']); ?>-600" fill="none"
                                                stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                        <?php elseif($aktivitas['icon'] === 'document'): ?>
                                            <svg class="w-6 h-6 text-<?php echo e($aktivitas['color']); ?>-600" fill="none"
                                                stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <?php elseif($aktivitas['icon'] === 'user-add'): ?>
                                            <svg class="w-6 h-6 text-<?php echo e($aktivitas['color']); ?>-600" fill="none"
                                                stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    stroke-width="2"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p class="text-sm font-semibold text-gray-800 mb-1">
                                            <?php echo e($aktivitas['judul']); ?></p>
                                        <p class="text-xs text-gray-500 mb-2"><?php echo e($aktivitas['deskripsi']); ?></p>
                ...
                <?php if(Auth::user()->role !== 'karyawan'): ?>
                    <div class="space-y-6">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($suratMenunggu) && $suratMenunggu->isNotEmpty()): ?>
                            <div
                                        ...
                                        <div class="flex items-start space-x-3">
                                            ...
                                            <div>
                                                <p class="text-sm font-medium text-gray-800">
                                                    <?php echo e($surat->jenis ?? 'Surat'); ?></p>
                                                <p class="text-xs text-gray-500"><?php echo e($surat->user->name ?? 'N/A'); ?> •
                                                    <?php echo e($surat->created_at->diffForHumans()); ?></p>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp5\htdocs\admin-KJT\resources\views/dashboard-admin.blade.php ENDPATH**/ ?>