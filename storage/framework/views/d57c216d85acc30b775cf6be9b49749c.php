                            ...
                            <select id="reportMonthSelect"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($m = 1; $m <= 12; $m++): ?>
                                    <option value="<?php echo e($m); ?>" <?php echo e($m === now()->month ? 'selected' : ''); ?>>
                                        <?php echo e(DateTime::createFromFormat('!m', $m)->format('F')); ?></option>
                        ...
                        <div>
                            ...
                            <select id="reportYearSelect"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($y = now()->year - 2; $y <= now()->year + 1; $y++): ?>
                                    <option value="<?php echo e($y); ?>" <?php echo e($y === now()->year ? 'selected' : ''); ?>>
                                        <?php echo e($y); ?></option>
                                <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </select>
                        </div>
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            ...
            function printReport() {
                ...
                const url = new URL('<?php echo e(route('direktur.laporan.cuti.pdf')); ?>', window.location.origin);
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Admin-KJT\resources\views/direktur/laporan-cuti.blade.php ENDPATH**/ ?>