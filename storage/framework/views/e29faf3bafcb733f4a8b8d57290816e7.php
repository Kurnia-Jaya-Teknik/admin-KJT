...
<body>
    ...
    <div class="subtitle">
        Nomor: <?php echo e($surat['nomor_surat'] ?? '01/HRD/I/2026'); ?>
    ...
    <div class="content">
        ...
        <div class="identity">
            <table>
                ...
                <tr>
                    <td>Jabatan</td>
                    <td>:</td>
                    <td><?php echo e($surat['jabatan']); ?></td>
                </tr>
                <tr>
        ...
        <p>
            ...
            <strong><?php echo e(\Carbon\Carbon::parse($surat['tanggal_mulai_kerja'])->translatedFormat('d F Y')); ?></strong>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($surat['tanggal_selesai_kerja'])): ?>
                sampai dengan
                <strong><?php echo e(\Carbon\Carbon::parse($surat['tanggal_selesai_kerja'])->translatedFormat('d F Y')); ?></strong>
            <?php else: ?>
                sampai sekarang
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            dengan jabatan terakhir <strong><?php echo e($surat['jabatan']); ?></strong>.
        </p>

        <p>
            Selama menjadi karyawan kami, Sdr. <strong><?php echo e($karyawan->name); ?></strong>
            telah menunjukkan dedikasi, loyalitas, dan kualitas kinerja yang tinggi
            terhadap perusahaan.
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($surat['tanggal_selesai_kerja'])): ?>
                Adapun proses penghentian hubungan kerja ini datang
    ...
    <div class="footer">
        <div class="right">
            <p>Pasuruan, <?php echo e(\Carbon\Carbon::parse($surat['tanggal_surat'])->translatedFormat('d F Y')); ?></p>
            <p>HRD,</p>
