                    ...
                    <div class="relative flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-slate-50 text-sm font-medium"><?php echo e(now()->locale('id')->isoFormat('dddd, D MMMM Y')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative overflow-hidden bg-gradient-to-r from-red-500/85 via-red-600/80 to-slate-600/75 rounded-3xl p-8 mb-8 shadow-lg border border-red-200/30">
                    <div class="relative flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h1 class="text-2xl font-bold mb-2 text-white">Selamat Datang, <?php echo e(Auth::user()->name); ?>! 👋</h1>
                                <p class="text-red-50/90 text-sm"><?php echo e(now()->locale('id')->isoFormat('dddd, D MMMM Y')); ?></p>
                            </div>
                        </div>
                ...
                <?php if(Auth::user()->role === 'direktur'): ?>
                    ...
                    <div class="group relative overflow-hidden bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-md rounded-3xl p-6 shadow-sm border border-gray-100/40 hover:shadow-lg hover:border-amber-100/60 transition-all duration-300 hover:-translate-y-1">
                        ...
                        <div class="relative">
                            ...
                            <h3 class="text-2xl font-bold text-gray-800 mb-0.5"><?php echo e(\App\Models\Cuti::where('status', 'Pending')->count()); ?></h3>
                    ...
                    <div class="group relative overflow-hidden bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-md rounded-3xl p-6 shadow-sm border border-gray-100/40 hover:shadow-lg hover:border-orange-100/60 transition-all duration-300 hover:-translate-y-1">
                        ...
                        <div class="relative">
                            ...
                            <h3 class="text-2xl font-bold text-gray-800 mb-0.5"><?php echo e(\App\Models\Lembur::where('status', 'Pending')->count()); ?></h3>
                    ...
                    <div class="group relative overflow-hidden bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-md rounded-3xl p-6 shadow-sm border border-gray-100/40 hover:shadow-lg hover:border-red-100/60 transition-all duration-300 hover:-translate-y-1">
                        ...
                        <div class="relative">
                            ...
                            <h3 class="text-2xl font-bold text-gray-800 mb-0.5"><?php echo e(\App\Models\Surat::whereIn('status', ['Draft', 'Menunggu Persetujuan'])->count()); ?></h3>
                    ...
                    <div class="group relative overflow-hidden bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-md rounded-3xl p-6 shadow-sm border border-gray-100/40 hover:shadow-lg hover:border-blue-100/60 transition-all duration-300 hover:-translate-y-1">
                        ...
                        <div class="relative">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <span class="text-xs font-medium text-blue-600/80 bg-blue-50/70 px-2.5 py-1.5 rounded-full border border-blue-200/30 shadow-sm">📊 <?php echo e($totalKaryawan > 0 ? round(($hadirHariIni/$totalKaryawan)*100) : 0); ?>%</span>
                            </div>
     ...
     <?php elseif(Auth::user()->role === 'admin_hrd'): ?>
                    ...
                    <div class="group relative overflow-hidden bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-md rounded-3xl p-6 shadow-sm border border-gray-100/40 hover:shadow-lg hover:border-slate-100/60 transition-all duration-300 hover:-translate-y-1">
                        ...
                        <div class="relative">
                            ...
                            <h3 class="text-2xl font-bold text-gray-800 mb-0.5"><?php echo e(number_format($totalKaryawan)); ?></h3>
                            <p class="text-sm text-gray-600 font-medium">Total Karyawan Aktif</p>
                        </div>
                    </div>
                    ...
                    <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="relative">
                                ...
                                <div class="pt-4">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="text-lg font-bold bg-gradient-to-r from-rose-500 to-rose-400 bg-clip-text text-transparent"><?php echo e($totalPengajuan6); ?> pengajuan</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="group relative overflow-hidden bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-md rounded-3xl shadow-sm border border-gray-100/40 hover:shadow-lg transition-all duration-300 p-6">
                            ...
                            <div class="relative">
                                ...
                                <?php
                                    $colors = [
                                        ['from' => 'orange-500', 'to' => 'orange-400', 'bar-from' => 'orange-400/80', 'bar-to' => 'orange-300/60'],
                                        ['from' => 'blue-500', 'to' => 'blue-400', 'bar-from' => 'blue-400/80', 'bar-to' => 'blue-300/60'],
                                        ['from' => 'emerald-500', 'to' => 'emerald-400', 'bar-from' => 'emerald-400/80', 'bar-to' => 'emerald-300/60'],
                                        ['from' => 'purple-500', 'to' => 'purple-400', 'bar-from' => 'purple-400/80', 'bar-to' => 'purple-300/60'],
                                        ['from' => 'pink-500', 'to' => 'pink-400', 'bar-from' => 'pink-400/80', 'bar-to' => 'pink-300/60'],
                                    ];
                                ?>
                                <div class="space-y-5">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $lemburPerDepartemen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <?php
                                            ...
                                            $widthPercent = $maxLemburJam > 0 ? round(($dept['total_jam'] / $maxLemburJam) * 100) : 0;
                                        ?>
                                        <div>
                                            <div class="flex items-center justify-between mb-2.5">
                                                <span class="text-sm font-medium text-gray-700"><?php echo e($dept['nama']); ?></span>
                                                <span class="text-sm font-bold bg-gradient-to-r from-<?php echo e($color['from']); ?> to-<?php echo e($color['to']); ?> bg-clip-text text-transparent"><?php echo e($dept['total_jam']); ?> jam</span>
                                            </div>
                                            <div class="w-full bg-gradient-to-r from-gray-200/40 to-gray-100/30 rounded-full h-3 shadow-sm overflow-hidden">
                                                <div class="bg-gradient-to-r from-<?php echo e($color['bar-from']); ?> to-<?php echo e($color['bar-to']); ?> h-3 rounded-full shadow-md transition-all duration-300 hover:shadow-lg" style="width: <?php echo e($widthPercent); ?>%"></div>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <p class="text-sm text-gray-500 text-center py-4">Belum ada data lembur bulan ini</p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                <div class="mt-5 pt-4 border-t border-gray-100/30 flex items-center justify-between">
                                    ...
                                    <span class="text-lg font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent"><?php echo e($totalLemburBulanIni); ?> jam</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="relative">
                                    ...
                                    <div class="relative w-48 h-48">
                                        <svg class="w-full h-full drop-shadow-sm" viewBox="0 0 140 140"
                                            ...
                                            <circle cx="70" cy="70" r="55" fill="none" stroke="#10b981"
                                                stroke-width="22" stroke-dasharray="<?php echo e($approvedDash); ?> <?php echo e($circumference); ?>"
                                                stroke-linecap="round" opacity="0.8" />
                                            <!-- Pending -->
                                            <circle cx="70" cy="70" r="55" fill="none" stroke="#f59e0b"
                                                stroke-width="22" stroke-dasharray="<?php echo e($pendingDash); ?> <?php echo e($circumference); ?>" stroke-dashoffset="-<?php echo e($approvedDash); ?>"
                                                stroke-linecap="round" opacity="0.8" />
                                            <!-- Rejected -->
                                            <circle cx="70" cy="70" r="55" fill="none" stroke="#ef4444"
                                                stroke-width="22" stroke-dasharray="<?php echo e($rejectedDash); ?> <?php echo e($circumference); ?>"
                                                stroke-dashoffset="-<?php echo e($approvedDash + $pendingDash); ?>" stroke-linecap="round" opacity="0.8" />
                                        </svg>
                                        <div class="absolute inset-0 flex items-center justify-center">
                                            <div class="text-center">
                                                <div class="text-3xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent"><?php echo e($total); ?></div>
                                ...
                                <div class="space-y-3 text-sm">
                                    <div class="flex items-center justify-between p-3 rounded-xl hover:bg-gradient-to-r hover:from-green-50/40 hover:to-transparent transition-colors duration-300">
                                        ...
                                        <span class="font-bold text-gray-800"><?php echo e($statusApproved); ?> (<?php echo e($approvedPct); ?>%)</span>
                                    </div>
                                    <div class="flex items-center justify-between p-3 rounded-xl hover:bg-gradient-to-r hover:from-amber-50/40 hover:to-transparent transition-colors duration-300">
                                        ...
                                        <span class="font-bold text-gray-800"><?php echo e($statusPending); ?> (<?php echo e($pendingPct); ?>%)</span>
                                    </div>
                                    <div class="flex items-center justify-between p-3 rounded-xl hover:bg-gradient-to-r hover:from-red-50/40 hover:to-transparent transition-colors duration-300">
                                        ...
                                        <span class="font-bold text-gray-800"><?php echo e($statusRejected); ?> (<?php echo e($rejectedPct); ?>%)</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center justify-between pb-3 border-b border-gray-100">
                                    ...
                                    <span class="font-bold text-lg text-green-600"><?php echo e($persetujuanSelesai ?? 0); ?></span>
                                </div>
                                <div class="flex items-center justify-between pb-3 border-b border-gray-100">
                                    <div class="flex items-center gap-2">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="font-bold text-lg text-slate-600"><?php echo e($hadirHariIni); ?>/<?php echo e($totalKaryawan); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                <?php elseif(Auth::user()->role === 'admin_hrd' && isset($pengajuanPerBulan)): ?>
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="group relative overflow-hidden bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-md rounded-3xl shadow-sm border border-gray-100/40 hover:shadow-lg transition-all duration-300 p-6">
                            ...
                            <div class="relative">
                                ...
                                <div class="flex gap-3 items-end border-b-2 border-gray-200/50 pb-4" style="height: 240px;">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $pengajuanPerBulan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="flex-1 flex flex-col items-center justify-end gap-2 group/bar">
                                            <div class="w-full bg-gradient-to-t from-<?php echo e($color); ?>-400/70 to-<?php echo e($color); ?>-300/50 rounded-t-xl shadow-md group-hover/bar:shadow-lg group-hover/bar:from-<?php echo e($color); ?>-400/90 group-hover/bar:to-<?php echo e($color); ?>-300/70 transition-all duration-300" style="height: <?php echo e($heightPx); ?>px;" title="<?php echo e($entry['count']); ?> pengajuan"></div>
                                            <span class="text-xs text-gray-700 font-medium mt-1.5"><?php echo e($entry['label']); ?></span>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                ...
                                <div class="pt-4 border-t border-gray-100/30 flex items-center justify-between mt-4">
                                    <span class="text-sm font-medium text-gray-600">Total 6 Bulan</span>
                                    <span class="text-lg font-bold bg-gradient-to-r from-indigo-600 to-indigo-500 bg-clip-text text-transparent"><?php echo e($totalPengajuan6); ?> pengajuan</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-md rounded-3xl shadow-sm border border-gray-100/40 p-6">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex items-center justify-between pt-2 border-t border-gray-100">
                                        ...
                                        <span class="font-bold text-lg text-gray-800"><?php echo e($cutiPending + $lemburPending); ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-6 mb-2">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center justify-between mb-3">
                                        ...
                                        <div id="countApproved" class="text-sm font-bold text-gray-800"><?php echo e($statusApproved); ?></div>
                                    </div>
                                    ...
                                    <div class="flex items-center justify-between mb-3">
                                        ...
                                        <div id="countPending" class="text-sm font-bold text-gray-800"><?php echo e($statusPending); ?></div>
                                    </div>
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div id="countRejected" class="text-sm font-bold text-gray-800"><?php echo e($statusRejected); ?></div>
                                    </div>
                                </div>
                            </div>
                ...
                <?php else: ?>
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm border border-gray-100/50 p-5">
                            ...
                            <div class="space-y-3">
                                <a href="<?php echo e(route('karyawan.pengajuan-cuti')); ?>" class="block w-full bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-medium text-sm py-2.5 px-4 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 text-center">
                                    Ajukan Cuti
                                </a>
                                <a href="<?php echo e(route('karyawan.pengajuan-lembur')); ?>" class="block w-full bg-gradient-to-r from-slate-600 to-slate-700 hover:from-slate-700 hover:to-slate-800 text-white font-medium text-sm py-2.5 px-4 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 text-center">
                                    Ajukan Lembur
                                </a>
                                <a href="<?php echo e(route('karyawan.surat')); ?>" class="block w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-medium text-sm py-2.5 px-4 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 text-center">
                                    Surat Saya
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm border border-gray-100/50 p-5">
                            ...
                            <a href="<?php echo e(route('karyawan.riwayat')); ?>" class="mt-3 block text-center text-xs font-medium text-slate-600 hover:text-slate-700">
                                Lihat Semua →
                            </a>
                        </div>
    ...
    <!-- Pending Requests - Direktur (Card Format) -->
            ...
            <?php elseif(Auth::user()->role === 'admin_hrd'): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $suratMenunggu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $surat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div id="surat-modal-<?php echo e($surat->id); ?>" class="js-modal hidden fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
                        <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                            ...
                            <div class="sticky top-0 px-6 py-5 bg-gradient-to-r from-purple-50 to-purple-50 border-b border-gray-200 flex items-center justify-between">
                                ...
                                <button onclick="document.getElementById('surat-modal-<?php echo e($surat->id); ?>').classList.add('hidden')" class="text-gray-400 hover:text-gray-600">
                            ...
                            <div class="px-6 py-6 space-y-6">
                                ...
                                <div class="bg-gray-50 rounded-lg p-4 space-y-3">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm font-semibold text-gray-800"><?php echo e($surat->user->name); ?></p>
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm font-semibold text-gray-800"><?php echo e($surat->nomor_surat); ?></p>
                                        </div>
                                        <div>
                                            <p class="text-xs text-gray-500">Status</p>
                                            <span class="text-xs font-semibold px-2.5 py-1 rounded-full <?php echo e($surat->status === 'Pending' ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-800'); ?>"><?php echo e($surat->status); ?></span>
                                        </div>
                                        <div>
                                            <p class="text-xs text-gray-500">Tanggal Pengajuan</p>
                                            <p class="text-sm font-semibold text-gray-800"><?php echo e($surat->created_at->format('d M Y')); ?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-4 space-y-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-800 whitespace-pre-wrap"><?php echo e($surat->isi_surat); ?></p>
                                        </div>
                                        <div>
                                ...
                                <div class="flex items-center gap-3 pt-4 border-t">
                                    <button onclick="approveAction(<?php echo e($surat->id); ?>)" class="flex-1 px-4 py-2 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition-colors">
                                        Setujui
                                    </button>
                                    <button onclick="rejectAction(<?php echo e($surat->id); ?>)" class="flex-1 px-4 py-2 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-colors">
                                        Tolak
                                    </button>
                                    <button onclick="deleteAction(<?php echo e($surat->id); ?>)" class="flex-1 px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white font-medium rounded-lg transition-colors">
                                        Hapus
                                    </button>
                                    <button onclick="document.getElementById('surat-modal-<?php echo e($surat->id); ?>').classList.add('hidden')" class="flex-1 px-4 py-2 bg-gray-300 hover:bg-gray-400 text-gray-800 font-medium rounded-lg transition-colors">
                                        Tutup
                                    </button>
                                </div>
                            </div>
