    ...
    <div class="page">
        ...
        <div class="letter-content" >
            ...
            <div class="info-line">
                ...
                <span class="info-value"><?php echo e($karyawan->tanggal_bergabung ? \Carbon\Carbon::parse($karyawan->tanggal_bergabung)->format('d/m/Y') : ''); ?></span>
            </div>
            ...
            <div class="info-line">
                ...
                <span class="info-value info-value-short"><?php echo e($cuti->tanggal_mulai ? \Carbon\Carbon::parse($cuti->tanggal_mulai)->format('d/m/Y') : ''); ?></span>
            </div>

            <div class="info-line">
                <span class="info-label">Sampai Tanggal</span>
                <span class="info-value info-value-short"><?php echo e($cuti->tanggal_selesai ? \Carbon\Carbon::parse($cuti->tanggal_selesai)->format('d/m/Y') : ''); ?></span>
        ...
        <div class="signature-section">
            <div class="date-line">
                Pasuruan, <?php echo e(now()->format('d/m/Y')); ?>
