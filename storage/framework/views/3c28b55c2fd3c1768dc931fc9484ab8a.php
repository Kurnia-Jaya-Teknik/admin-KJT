                                ...
                                <tr class="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-8 py-6 text-center">
                                        <div class="flex gap-2 justify-center flex-wrap">
                                            <a href="<?php echo e(asset('storage/' . $surat->file_surat)); ?>" target="_blank" class="px-4 py-2 bg-blue-100/60 text-blue-700 font-medium rounded-xl hover:bg-blue-100 transition-colors text-sm">
