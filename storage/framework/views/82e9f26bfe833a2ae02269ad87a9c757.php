...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Ringkasan Karyawan')); ?>
        ...
        <div class="p-6 lg:p-8 bg-white min-h-full">
            ...
            <div class="mb-6 border-b border-gray-200">
                <nav class="flex space-x-8">
                    <a href="<?php echo e(route('direktur.ringkasan-karyawan')); ?>"
                        class="<?php echo e(!request()->is('direktur/ringkasan-karyawan/kelola') ? 'border-red-500 text-red-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'); ?> whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                        📊 Ringkasan
                    </a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 mb-1"><?php echo e($totalKaryawan); ?></h3>
                ...
                <div
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 mb-1"><?php echo e($pkwtt); ?></h3>
                ...
                <div
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 mb-1"><?php echo e($pkwt); ?></h3>
                ...
                <div
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 mb-1"><?php echo e($magang); ?></h3>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                ...
                <div class="bg-white rounded-2xl shadow-md border border-gray-200 p-6">
                    ...
                    <div class="h-64 flex items-center justify-center relative">
                        ...
                        <svg class="w-48 h-48" viewBox="0 0 120 120">
                            <circle cx="60" cy="60" r="50" fill="none" stroke="#8b5cf6"
                                stroke-width="12" stroke-dasharray="<?php echo e($pkwttPct); ?> 314"
                                transform="rotate(-90 60 60)" />
                            <circle cx="60" cy="60" r="50" fill="none" stroke="#f59e0b"
                                stroke-width="12" stroke-dasharray="<?php echo e($pkwtPct); ?> 314"
                                stroke-dashoffset="-<?php echo e($pkwttPct); ?>" transform="rotate(-90 60 60)" />
                            <circle cx="60" cy="60" r="50" fill="none" stroke="#10b981"
                                stroke-width="12" stroke-dasharray="<?php echo e($magangPct); ?> 314"
                                stroke-dashoffset="-<?php echo e($pkwttPct + $pkwtPct); ?>" transform="rotate(-90 60 60)" />
                            <text x="60" y="65" text-anchor="middle" font-size="20" font-weight="bold"
                                fill="#1f2937"><?php echo e($totalKaryawan); ?></text>
                        </svg>
                    </div>
                    <div class="mt-6 space-y-3">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="font-semibold text-gray-800"><?php echo e($pkwtt); ?>

                                (<?php echo e($totalKaryawan > 0 ? round(($pkwtt / $totalKaryawan) * 100) : 0); ?>%)</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                            ...
                            <span class="font-semibold text-gray-800"><?php echo e($pkwt); ?>

                                (<?php echo e($totalKaryawan > 0 ? round(($pkwt / $totalKaryawan) * 100) : 0); ?>%)</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                            ...
                            <span class="font-semibold text-gray-800"><?php echo e($magang); ?>

                                (<?php echo e($totalKaryawan > 0 ? round(($magang / $totalKaryawan) * 100) : 0); ?>%)</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-2 bg-white rounded-2xl shadow-md border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $departemens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div>
                                <div class="flex items-center justify-between mb-2">
                                    <span class="text-sm font-medium text-gray-700"><?php echo e($dept->nama); ?></span>
                                    <span class="text-sm font-semibold text-gray-800"><?php echo e($dept->users_count); ?></span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-2">
                                    ...
                                    ?>
                                    <div class="bg-<?php echo e($color); ?>-400 h-2 rounded-full"
                                        style="width: <?php echo e($widthPct); ?>%"></div>
                                </div>
                            </div>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $departemens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="hover:bg-red-50 transition-colors duration-150">
                                    <td class="px-6 py-4 text-sm font-medium text-gray-800"><?php echo e($dept->nama); ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($deptPkwtt); ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($deptPkwt); ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($deptMagang); ?></td>
                                    <td class="px-6 py-4 text-sm font-semibold text-gray-800"><?php echo e($deptTotal); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($countAdminHrd > 0): ?>
                                <?php
                                ...
                                <tr class="hover:bg-blue-50 transition-colors duration-150 bg-blue-50/50">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($adminPkwtt); ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($adminPkwt); ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($adminMagang); ?></td>
                                    <td class="px-6 py-4 text-sm font-semibold text-blue-700"><?php echo e($countAdminHrd); ?>

                                    </td>
                                </tr>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($countTanpaDivisi > 0): ?>
                                <?php
                                ...
                                <tr class="hover:bg-yellow-50 transition-colors duration-150 bg-yellow-50/50">
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($tanpaDivisiPkwtt); ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($tanpaDivisiPkwt); ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($tanpaDivisiMagang); ?></td>
                                    <td class="px-6 py-4 text-sm font-semibold text-yellow-700">
                                        <?php echo e($countTanpaDivisi); ?></td>
                                </tr>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </tbody>
                        <tfoot>
                            <tr class="bg-gradient-to-r from-red-600 to-red-700 border-t-2 border-red-800">
                                ...
                                <td class="px-6 py-4 text-sm font-bold text-white"><?php echo e($pkwtt); ?></td>
                                <td class="px-6 py-4 text-sm font-bold text-white"><?php echo e($pkwt); ?></td>
                                <td class="px-6 py-4 text-sm font-bold text-white"><?php echo e($magang); ?></td>
                                <td class="px-6 py-4 text-sm font-bold text-white"><?php echo e($totalKaryawan); ?></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Admin-KJT\resources\views/direktur/ringkasan-karyawan.blade.php ENDPATH**/ ?>