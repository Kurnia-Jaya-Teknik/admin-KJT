                                ...
                                <tr class="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-8 py-6 text-center">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($surat->is_sent): ?>
                                            <div class="inline-flex items-center gap-2">
                                                ...
                                                <span class="text-xs text-gray-500"><?php echo e($surat->sent_at?->format('d/m/Y H:i')); ?></span>
                                            </div>
                                        <?php else: ?>
                                    ...
                                    <td class="px-8 py-6 text-center">
                                        <div class="flex gap-2 justify-center flex-wrap">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$surat->is_sent): ?>
                                            <button onclick="sendSurat(<?php echo e($surat->id); ?>, '<?php echo e($surat->user->name); ?>')" class="px-4 py-2 bg-green-100/60 text-green-700 font-medium rounded-xl hover:bg-green-100 transition-colors text-sm">
                                                <svg class="w-4 h-4 inline mr-1" fill="currentColor" viewBox="0 0 20 20">
...
<?php /**PATH C:\xampp\htdocs\Admin-KJT\resources\views/admin/surat-keterangan.blade.php ENDPATH**/ ?>