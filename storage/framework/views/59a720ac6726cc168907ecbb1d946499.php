        ...
        <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
            ...
            <form id="requestForm" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="date" id="tanggal_diminta" name="tanggal_diminta" required min="<?php echo e(date('Y-m-d')); ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all">
