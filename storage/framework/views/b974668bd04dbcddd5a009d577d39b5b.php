    ...
    <div class="p-6 flex-1 overflow-y-auto">
        ...
        <div class="flex items-center space-x-3 mb-8 pb-6 border-b border-gray-100">
            ...
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->departemen): ?>
        ...
        <nav class="space-y-2">
            ...
            <?php elseif(Auth::user()->role === 'direktur'): ?>
                ...
                <a href="<?php echo e(route('direktur.persetujuan-cuti')); ?>"
                    class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('direktur.persetujuan-cuti') ? 'bg-gradient-to-r from-red-50 to-slate-50 text-red-700 font-medium' : 'text-gray-600 hover:bg-red-50 hover:text-red-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                ...
                <a href="<?php echo e(route('direktur.persetujuan-izin-sakit')); ?>"
                    class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('direktur.persetujuan-izin-sakit') ? 'bg-gradient-to-r from-red-50 to-slate-50 text-red-700 font-medium' : 'text-gray-600 hover:bg-red-50 hover:text-red-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                ...
                <a href="<?php echo e(route('direktur.profil')); ?>"
                    class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('direktur.profil') ? 'bg-gradient-to-r from-green-50 to-emerald-50 text-green-700 font-medium' : 'text-gray-600 hover:bg-green-50 hover:text-green-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <?php else: ?>
                ...
                <a href="<?php echo e(route('karyawan.pengajuan-cuti')); ?>"
                    ...
                    <span>Pengajuan Cuti</span>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->cuti_pending > 0): ?>
                        <span
                ...
                <a href="<?php echo e(route('karyawan.pengajuan-lembur')); ?>"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->lembur_pending > 0): ?>
                        <span
                ...
                <div class="relative">
                    <button type="button" onclick="toggleSuratMenu()"
                        class="w-full flex items-center justify-between space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('karyawan.surat*') || request()->is('karyawan/surat-keterangan*') ? 'bg-gradient-to-r from-red-50 to-slate-50 text-red-700 font-medium' : 'text-gray-600 hover:bg-red-50 hover:text-red-700'); ?>">
                        <span class="flex items-center space-x-3">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    ...
                    <div id="suratMenu" class="mt-2 ml-2 mr-2 space-y-1 hidden">
                        ...
                        <a href="<?php echo e(route('karyawan.surat')); ?>"
                            class="flex items-center justify-between px-3 py-2.5 rounded-lg hover:bg-red-50 text-sm <?php echo e(request()->routeIs('karyawan.surat') ? 'text-red-700 font-semibold bg-red-100' : 'text-gray-700 hover:text-red-700'); ?>">
                            <span>Surat Saya</span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->surat_pending > 0): ?>
                                <span
                                    class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold bg-red-100 text-red-800"><?php echo e(Auth::user()->surat_pending); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </a>

                        <!-- Permintaan Surat Keterangan -->
                        <a href="<?php echo e(route('karyawan.surat-keterangan.request.index')); ?>"
                            class="block px-3 py-2.5 rounded-lg hover:bg-red-50 text-sm <?php echo e(request()->routeIs('karyawan.surat-keterangan.request.*') ? 'text-red-700 font-semibold bg-red-100' : 'text-gray-700 hover:text-red-700'); ?>">
                            Permintaan Surat Keterangan
                        </a>

                        <!-- Surat Keterangan Diterima -->
                        <a href="/karyawan/surat-keterangan"
                            class="flex items-center justify-between px-3 py-2.5 rounded-lg hover:bg-red-50 text-sm <?php echo e(request()->is('karyawan/surat-keterangan') && !request()->is('karyawan/surat-keterangan-*') ? 'text-red-700 font-semibold bg-red-100' : 'text-gray-700 hover:text-red-700'); ?>"
