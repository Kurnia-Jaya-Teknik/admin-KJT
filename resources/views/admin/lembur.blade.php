            ...
            <div class="p-8 space-y-6">
                ...
                <div class="bg-gradient-to-br from-red-50/40 to-slate-50/30 rounded-2xl p-6 border border-red-100/30">
                    <div class="flex items-start gap-4 mb-4">
                        ...
                        <div class="flex-1">
                            <h3 class="text-xl font-bold text-gray-900">Siti Nurhaliza</h3>
                            <p class="text-sm text-gray-600 mt-0.5">ID: EMP001 • Departemen: Operations</p>
                            <p class="text-sm text-gray-500 mt-1">Email: siti.nurhaliza@company.com</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/70 rounded-2xl p-5 border border-gray-100/40">
                    ...
                    <p class="text-gray-700 leading-relaxed">Deadline project yang mendesak memerlukan penyelesaian dalam waktu singkat. Koordinasi dengan tim telah dilakukan dan lembur diperlukan untuk memastikan deliverable tepat waktu sesuai requirement klien.</p>
                </div>
                    ...
                    <div class="space-y-2">
                        <div class="flex items-start gap-3 p-3 bg-gradient-to-r from-red-50/40 to-slate-50/30 rounded-2xl border border-red-100/30">
                            ...
                            <div class="flex-1 text-sm">
                                ...
                                <p class="text-gray-600">12 Januari 2026, 16:45</p>
                            </div>
                        </div>
