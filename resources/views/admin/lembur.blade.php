<x-app-layout>
        ...
        <div class="p-6 lg:p-8 bg-gray-50/50 min-h-full">
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
                ...
                <div class="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-md rounded-3xl shadow-sm border border-gray-100/40 p-6 hover:shadow-md transition-all duration-300 group overflow-hidden relative">
                    ...
                    <div class="relative">
                        <div class="w-12 h-12 bg-gradient-to-br from-amber-100/60 to-amber-50/30 rounded-2xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
            ...
            <div class="space-y-4">
                <!-- Pending Item 1 -->
                <div data-id="4" data-status="pending" data-name="Siti Nurhaliza" data-nik="EMP001" data-email="siti.nurhaliza@company.com" data-dept="Operations" data-created="12 Januari 2026, 16:45" data-tanggal="12 Januari 2026" data-jam-mulai="17:00" data-jam-selesai="20:00" data-durasi="3 jam" data-keterangan="Deadline project urgent" class="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-md rounded-3xl shadow-sm border border-gray-100/40 p-6 hover:shadow-lg hover:border-amber-200/40 transition-all duration-300 group overflow-hidden relative">
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1 ml-2">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm mb-4 p-4 bg-gradient-to-br from-gray-50/50 to-slate-50/30 rounded-2xl border border-gray-100/30">
                                ...
                                <div>
                                    <p class="text-gray-600 text-xs font-medium uppercase tracking-wide mb-1">Jam Lembur</p>
                                ...
                                <div>
                                    <p class="text-gray-600 text-xs font-medium uppercase tracking-wide mb-1">Departemen</p>
                                    <p class="font-semibold text-gray-900">Operations</p>
                                </div>
                            </div>
                            <div class="pl-4 border-l-2 border-gray-200/50">
                                <p class="text-sm text-gray-600"><span class="font-medium">Keterangan:</span> Deadline project urgent</p>
                            </div>
                        </div>
                ...
                <!-- Approved Item 1 -->
                <div data-id="2" data-status="approved" data-name="Rudi Hermawan" data-nik="EMP002" data-email="rudi.hermawan@company.com" data-dept="IT" data-created="14 Januari 2026, 15:20" data-approved="16 Januari 2026, 09:00" data-tanggal="14 Januari 2026" data-jam-mulai="18:00" data-jam-selesai="21:00" data-durasi="3 jam" data-keterangan="Overload workload" class="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-md rounded-3xl shadow-sm border border-gray-100/40 p-6 hover:shadow-lg hover:border-green-200/40 transition-all duration-300 group overflow-hidden relative">
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1 ml-2">
                            ...
                            <div class="pl-4 border-l-2 border-gray-200/50">
                                <p class="text-sm text-gray-600"><span class="font-medium">Keterangan:</span> Kampanye persiapan launch</p>
                            </div>
                        </div>
                ...
                <!-- Approved Item 2 -->
                <div data-id="3" data-status="approved" class="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-md rounded-3xl shadow-sm border border-gray-100/40 p-6 hover:shadow-lg hover:border-green-200/40 transition-all duration-300 group overflow-hidden relative">
                    <div class="absolute top-0 left-0 w-1.5 h-full bg-gradient-to-b from-green-500/80 to-green-400/30 rounded-l-3xl"></div>
                    <div class="flex items-start justify-between">
                        <div class="flex-1 ml-2">
                            <div class="flex items-center gap-3 mb-4">
                            ...
                            <div class="pl-4 border-l-2 border-gray-200/50">
                                <p class="text-sm text-gray-600"><span class="font-medium">Keterangan:</span> Closing buku bulanan</p>
                            </div>
                        </div>
                        <button onclick="openDetailModal('approved', this.closest('[data-id]').dataset.id)" class="ml-4 px-4 py-2 bg-gradient-to-r from-green-500/80 to-green-400/70 text-white font-medium rounded-2xl hover:from-green-500 hover:to-green-400 shadow-sm hover:shadow-md transition-all duration-300 text-sm whitespace-nowrap flex-shrink-0 group-hover:scale-105">Lihat Detail</button>
                    </div>
                ...
                <!-- Pending Item 2 -->
                <div data-id="4" data-status="pending" class="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-md rounded-3xl shadow-sm border border-gray-100/40 p-6 hover:shadow-lg hover:border-amber-200/40 transition-all duration-300 group overflow-hidden relative">
                    <div class="absolute top-0 left-0 w-1.5 h-full bg-gradient-to-b from-amber-500/80 to-amber-400/30 rounded-l-3xl"></div>
                    <div class="flex items-start justify-between">
                        <div class="flex-1 ml-2">
                            <div class="flex items-center gap-3 mb-4">
                            ...
                            <div class="pl-4 border-l-2 border-gray-200/50">
                                <p class="text-sm text-gray-600"><span class="font-medium">Keterangan:</span> Rekrutmen interview lanjutan</p>
                            </div>
                        </div>
                        <button onclick="openDetailModal('pending', this.closest('[data-id]').dataset.id)" class="ml-4 px-4 py-2 bg-gradient-to-r from-red-500/80 to-red-400/70 text-white font-medium rounded-2xl hover:from-red-500 hover:to-red-400 shadow-sm hover:shadow-md transition-all duration-300 text-sm whitespace-nowrap flex-shrink-0 group-hover:scale-105">Lihat Detail</button>
                    </div>
                ...
                <div class="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-md rounded-3xl shadow-sm border border-gray-100/40 p-6 hover:shadow-lg hover:border-red-200/40 transition-all duration-300 group overflow-hidden relative">
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1 ml-2">
                            ...
                            <div class="pl-4 border-l-2 border-gray-200/50">
                                <p class="text-sm text-gray-600"><span class="font-medium">Catatan:</span> Melebihi batas jam lembur bulan ini</p>
                            </div>
                        </div>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1 ml-2">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <span class="ml-auto inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium bg-gradient-to-r from-red-100/60 to-red-50/40 text-red-600/80 border border-red-200/30 shadow-sm">⏳ Menunggu</span>
                            </div>
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm mb-4 p-4 bg-gradient-to-br from-gray-50/50 to-slate-50/30 rounded-2xl border border-gray-100/30">
                                <div>
                                    <p class="text-gray-600 text-xs font-medium uppercase tracking-wide mb-1">Tanggal</p>
                            ...
                            <div class="pl-4 border-l-2 border-gray-200/50">
                                <p class="text-sm text-gray-600"><span class="font-medium">Keterangan:</span> System maintenance emergency</p>
                            </div>
                        </div>
                        <button onclick="openDetailModal()" class="ml-4 px-4 py-2 bg-gradient-to-r from-red-500/80 to-red-400/70 text-white font-medium rounded-2xl hover:from-red-500 hover:to-red-400 shadow-sm hover:shadow-md transition-all duration-300 text-sm whitespace-nowrap flex-shrink-0 group-hover:scale-105">Lihat Detail</button>
                    </div>
    ...
    <div id="detailModal" class="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 hidden flex items-center justify-center p-4">
        <div class="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in duration-300">
            <!-- Modal Header -->
            <div class="sticky top-0 bg-gradient-to-r from-red-50/80 to-slate-50/60 backdrop-blur-md border-b border-gray-100/40 p-6 flex items-start justify-between">
                <div>
    ...
    <div id="buatSuratModal" class="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 hidden flex items-center justify-center p-4">
        <div class="bg-white rounded-3xl shadow-2xl max-w-md w-full animate-in fade-in zoom-in duration-300">
            <div class="p-8 text-center">
                ...
                <p class="text-gray-600 mb-6">Surat lembur untuk <span id="buatSuratEmployeeName">-</span> akan dibuat. Pastikan sudah disetujui oleh direktur.</p>
    ...
    <div id="approvalModal" class="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 hidden flex items-center justify-center p-4">
        <div class="bg-white rounded-3xl shadow-2xl max-w-md w-full animate-in fade-in zoom-in duration-300">
            <div class="p-8 text-center">
                ...
                <p class="text-gray-600 mb-6">Anda akan menyetujui pengajuan lembur Siti Nurhaliza untuk 3 jam (12 Jan 2026)</p>
                <div class="flex gap-3">
    ...
    <script>
        ...
        function showPdfPreviewModal(previewUrl) {
            ...
            if (!previewModal) {
                ...
                previewModal.className = 'fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 hidden';
