                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-md rounded-3xl shadow-sm border border-gray-100/40 p-6 hover:shadow-md transition-all duration-300 group overflow-hidden relative">
                        ...
                        <div class="relative">
                            ...
                            <p class="text-3xl font-bold text-gray-900" data-stat="total">{{ $magangList->total() }}</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-md rounded-3xl shadow-sm border border-gray-100/40 p-6 hover:shadow-md transition-all duration-300 group overflow-hidden relative">
                        ...
                        <div class="relative">
                            ...
                            <p class="text-3xl font-bold text-rose-600/80" data-stat="permintaan">{{ $magangList->where('status', 'Permintaan Surat')->count() }}</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-md rounded-3xl shadow-sm border border-gray-100/40 p-6 hover:shadow-md transition-all duration-300 group overflow-hidden relative">
                        ...
                        <div class="relative">
                            ...
                            <p class="text-3xl font-bold text-green-600/80" data-stat="selesai">{{ $magangList->where('status', 'Surat Selesai')->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ...
                                <tr class="hover:bg-slate-50/40 transition-colors duration-200 group" data-magang-id="{{ $magang->id }}">
                                        <td class="px-8 py-6">
                                        ...
                                        <td class="px-8 py-6">
                                            ...
                                            @elseif($magang->status === 'Surat Selesai')
                                            ...
                                            @else
                                                <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium bg-gradient-to-r from-gray-100/60 to-gray-50/40 text-gray-600/80 border border-gray-200/30 shadow-sm">{{ $magang->status }}</span>
                                            @endif
                                        </td>
                                        <td class="px-8 py-6 text-center">
                                            <button class="btn-lihat-detail px-4 py-2 bg-gradient-to-r from-rose-500/80 to-rose-400/70 text-white font-medium rounded-2xl hover:from-rose-500 hover:to-rose-400 shadow-sm hover:shadow-md transition-all duration-300 text-sm whitespace-nowrap group-hover:scale-105" data-magang-id="{{ $magang->id }}">
                                                Lihat Detail
                                            </button>
                                        </td>
                                    </tr>
