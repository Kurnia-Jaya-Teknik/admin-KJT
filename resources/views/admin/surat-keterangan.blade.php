<x-app-layout>
    ...
    <div class="flex-1 lg:ml-64 overflow-y-auto h-[calc(100vh-4rem)]">
        <div class="p-6 lg:p-8 bg-gray-50/50 min-h-full">
            ...
            <div class="mb-12">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
                    ...
                    <button onclick="showCreateModal()"
                        class="flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-400 text-white font-semibold rounded-2xl hover:from-blue-600 hover:to-blue-500 shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105 w-fit">
                        ...
                        <div class="flex items-center gap-4">
                            <div class="w-12 h-12 bg-amber-100/60 rounded-2xl flex items-center justify-center">
                                <svg class="w-6 h-6 text-amber-600" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <path fill-rule="evenodd"
                                        d="M4 5a2 2 0 012-2 1 1 0 000 2h10a1 1 0 000-2 2 2 0 00-2 2v10a2 2 0 002 2 1 1 0 100-2h-10a1 1 0 000 2 2 2 0 00-2-2V5z"
                                        clip-rule="evenodd" />
                                </svg>
                            </div>
                            <div>
            ...
            <div id="contentDibuat"
                class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hidden">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                @foreach ($suratList as $surat)
                                    <tr class="hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td class="px-8 py-6 font-mono text-sm text-gray-700">{{ $surat->nomor_surat }}
                                        </td>
                                        ...
                                        <td class="px-8 py-6 text-center">
                                            @if ($surat->is_sent)
                                                <div class="inline-flex items-center gap-2">
                                                    <span
                                                        class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-100/70 text-green-700 font-semibold rounded-full text-xs">
                                                    ...
                                                    <span
                                                        class="text-xs text-gray-500">{{ $surat->sent_at?->format('d/m/Y H:i') }}</span>
                                                </div>
                                            @else
                                                <span
                                                    class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-amber-100/70 text-amber-700 font-semibold rounded-full text-xs">
                                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fill-rule="evenodd"
                                        ...
                                        <td class="px-8 py-6 text-center">
                                            <div class="flex gap-2 justify-center items-center">
                                                <button
                                                    ...
                                                    class="px-4 py-2.5 bg-blue-100/60 text-blue-700 font-medium rounded-xl hover:bg-blue-100 transition-colors text-sm whitespace-nowrap">
                                                ...
                                                @if (!$surat->is_sent)
                                                    <button
                                                        ...
                                                        class="px-4 py-2.5 bg-green-100/60 text-green-700 font-medium rounded-xl hover:bg-green-100 transition-colors text-sm whitespace-nowrap">
                                                        <svg class="w-4 h-4 inline mr-1" fill="currentColor"
                                                            viewBox="0 0 20 20">
                                                            <path
                                                ...
                                                @if (!$surat->is_sent)
                                                    <button onclick="showEditModal({{ $surat->id }})"
                                                        class="px-4 py-2.5 bg-amber-100/60 text-amber-700 font-medium rounded-xl hover:bg-amber-100 transition-colors text-sm whitespace-nowrap">
                                                        <svg class="w-4 h-4 inline mr-1" fill="currentColor"
                                                            viewBox="0 0 20 20">
                                                            <path
                                                ...
                                                <button onclick="deleteSurat({{ $surat->id }})"
                                                    class="px-4 py-2.5 bg-red-100/60 text-red-700 font-medium rounded-xl hover:bg-red-100 transition-colors text-sm whitespace-nowrap">
                                                    <svg class="w-4 h-4 inline mr-1" fill="currentColor"
                                                        viewBox="0 0 20 20">
                                                        <path fill-rule="evenodd"
                ...
                @else
                    <div class="p-12 text-center">
                        ...
                        <button onclick="showCreateModal()"
                            class="px-6 py-3 bg-blue-500 text-white font-semibold rounded-2xl hover:bg-blue-600 transition-colors">
                            Buat Surat Pertama
                        </button>
                    </div>
                @endif
        ...
        <div
            ...
            <form id="suratForm" class="p-8 space-y-6">
                ...
                <div>
                    ...
                    <select id="userId" name="user_id"
                        class="w-full px-4 py-3 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"
                        required>
                ...
                <div>
                    ...
                    <textarea id="keterangan" name="keterangan" rows="3"
                        ...
                        class="w-full px-4 py-3 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all"></textarea>
                </div>
            </form>
            ...
            <div
                ...
                <button onclick="closeCreateModal()"
                    class="px-8 py-3 border border-gray-200/60 rounded-2xl text-gray-600 font-medium hover:bg-gray-50/70 transition-all duration-300">
                    Batal
                </button>
                <button onclick="submitForm()"
                    class="flex items-center justify-center gap-2 px-8 py-3 bg-gradient-to-r from-blue-500 to-blue-400 text-white font-semibold rounded-2xl hover:from-blue-600 hover:to-blue-500 shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
                            d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                            clip-rule="evenodd" />
    ...
    <div id="editModal"
        ...
        <div
            ...
            <!-- Modal Header -->
            <div
                class="sticky top-0 bg-gradient-to-r from-amber-50/80 to-slate-50/60 backdrop-blur-md border-b border-gray-100/40 p-6 flex items-start justify-between">
                <div>
                ...
                <button onclick="closeEditModal()" class="p-2 hover:bg-white/50 rounded-2xl transition-colors">
                    <svg class="w-6 h-6 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M6 18L18 6M6 6l12 12" />
                    </svg>
            ...
            <form id="editSuratForm" class="p-8 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="editNomorSurat" name="nomor_surat" placeholder="Contoh: 001/HRD/2026"
                        class="w-full px-4 py-3 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none transition-all"
                        required>
                </div>
                ...
                <div>
                    ...
                    <textarea id="editKeterangan" name="keterangan" rows="3"
                        placeholder="Contoh: Surat ini untuk keperluan pembukaan rekening bank"
                        class="w-full px-4 py-3 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none transition-all"></textarea>
                </div>
            </form>
            ...
            <div
                ...
                <button onclick="submitEditForm()"
                    class="flex items-center justify-center gap-2 px-8 py-3 bg-gradient-to-r from-amber-500 to-amber-400 text-white font-semibold rounded-2xl hover:from-amber-600 hover:to-amber-500 shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path
                            d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                    </svg>
    ...
    <div id="detailModal"
        ...
        <div class="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div
                class="border-t border-gray-100/40 bg-gradient-to-r from-gray-50/50 to-slate-50/30 px-8 py-6 flex gap-4 justify-end">
                ...
                <button onclick="showCreateSuratForm()"
                    class="px-8 py-3 bg-gradient-to-r from-blue-500 to-blue-400 text-white font-semibold rounded-2xl hover:from-blue-600 hover:to-blue-500 shadow-md hover:shadow-lg transition-all transform hover:scale-105">
    ...
    <div id="previewSuratModal"
        ...
        <div class="bg-white rounded-3xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
            <div
                class="sticky top-0 bg-gradient-to-r from-blue-50/80 to-slate-50/60 backdrop-blur-md border-b border-gray-100/40 px-8 py-6 flex items-start justify-between">
                <div>
            ...
            <div
                ...
                <a id="downloadSuratBtn" href="#" target="_blank"
                    class="flex items-center justify-center gap-2 px-8 py-3 bg-gradient-to-r from-green-500 to-green-400 text-white font-semibold rounded-2xl hover:from-green-600 hover:to-green-500 shadow-md hover:shadow-lg transition-all transform hover:scale-105">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
        ...
        <div class="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div
                ...
                <button onclick="closeCreateFromRequestModal()"
                    class="p-2 hover:bg-white/50 rounded-2xl transition-colors">
                    <svg class="w-6 h-6 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M6 18L18 6M6 6l12 12" />
                    </svg>
...
<script>
    ...
    function sendSurat(id, namaKaryawan) {
        if (!confirm('Kirim surat keterangan ke ' + namaKaryawan + '?')) return;
                ...
                <tr class="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td class="px-8 py-6 text-center">
                        <div class="flex gap-2 justify-center flex-wrap">
                            ${!surat.is_sent ? `
                            <button onclick="showEditModal(${surat.id})" class="px-4 py-2 bg-amber-100/60 text-amber-700 font-medium rounded-xl hover:bg-amber-100 transition-colors text-sm">
                                <svg class="w-4 h-4 inline mr-1" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            ` : ''}
                            <button onclick="previewSurat(${surat.id}, '${userName.replace(/'/g, "\\'")}')" class="px-4 py-2 bg-blue-100/60 text-blue-700 font-medium rounded-xl hover:bg-blue-100 transition-colors text-sm">
                                <svg class="w-4 h-4 inline mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10 12a2 2 0 100-4 2 2 0 000 4z"/>
                                    <path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd"/>
                                </svg>
                            ...
                            ${!surat.is_sent ? `
                            <button onclick="sendSurat(${surat.id}, '${userName.replace(/'/g, "\\'")}')" class="px-4 py-2 bg-green-100/60 text-green-700 font-medium rounded-xl hover:bg-green-100 transition-colors text-sm">
                                <svg class="w-4 h-4 inline mr-1" fill="currentColor" viewBox="0 0 20 20">
