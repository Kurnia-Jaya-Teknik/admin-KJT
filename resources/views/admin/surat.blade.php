    ...
    <div class="flex-1 lg:ml-64 overflow-y-auto h-[calc(100vh-4rem)]">
        ...
        <div id="modalSurat" class="hidden fixed inset-0 z-50 flex items-center justify-center"
            ...
            <div
                ...
                <!-- Header -->
                <div
                    class="px-8 py-6 border-b border-gray-100 flex justify-between items-center bg-gradient-to-r from-indigo-50 to-blue-50 rounded-t-xl">
                    <div>
                    ...
                    <div id="formSteps" class="grid grid-cols-1 lg:grid-cols-2 gap-8 min-h-[600px]">
                        ...
                        <div class="flex flex-col space-y-6 overflow-y-auto pr-4">
                            ...
                            <div class="bg-white border border-gray-200 rounded-xl p-6">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-900 mb-2">Jenis
                                            Surat</label>
                                    ...
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-900 mb-2">Template
                                            Surat</label>
                                        <div class="flex items-center gap-2">
                                            <select id="suratTemplateSelect"
                                            ...
                                            <button type="button" id="openTemplateManager"
                                                class="px-4 py-3 bg-indigo-50 text-indigo-700 border border-indigo-200 rounded-lg hover:bg-indigo-100 transition font-medium">⚙️</button>
                                        </div>
                                        <div id="templateLoadStatus" class="text-xs text-gray-600 mt-2">Memuat
                                            template...</div>
                                        <div id="templateManager"
                                            class="mt-4 hidden bg-gray-50 p-4 rounded-lg border border-gray-200">
                                            ...
                                            <div class="flex gap-2">
                                                <button type="button" id="createTemplateBtn"
                                                    class="flex-1 px-3 py-2 bg-indigo-600 text-white rounded text-sm hover:bg-indigo-700 transition">+
                                                    Buat</button>
                                                <button type="button" id="refreshTemplatesBtn"
                                                    class="px-3 py-2 bg-white border text-sm rounded hover:bg-gray-50 transition">🔄</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="bg-white border border-gray-200 rounded-xl p-6">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-900 mb-2">Nomor
                                            Surat</label>
                                        <input type="text" id="nomorSurat" placeholder="Contoh: 001/HR/2026"
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition" />
                                    </div>
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-900 mb-2">Tanggal
                                            Surat</label>
                                        <input type="date" id="tanggalSurat"
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition" />
                                    </div>
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-900 mb-2">Untuk
                                            Karyawan</label>
                                    ...
                                    <div>
                                        <label
                                            class="block text-sm font-semibold text-gray-900 mb-2">Departemen</label>
                                        <input type="text" id="departemenSurat" placeholder="Misal: HR, IT"
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition" />
                                    </div>
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-900 mb-2">Tujuan
                                            Surat</label>
                                    ...
                                    <div id="informasiCustomControls" class="mt-4 border-t pt-4">
                                        <div class="flex items-center gap-2">
                                            <button id="toggleAddInformasiFieldBtn" type="button"
                                                class="px-3 py-2 bg-indigo-600 text-white rounded text-sm">+ Tambah
                                                Field Informasi</button>
                                            <span class="text-sm text-gray-500">Tambahkan field kustom untuk Form
                                                Informasi Umum (akan berlaku untuk pembuatan surat saat ini, bisa
                                                disimpan sebagai template).</span>
                                        </div>

                                        <div id="addInformasiFieldForm"
                                            class="hidden mt-3 bg-gray-50 p-3 rounded border border-gray-200">
                                            <div class="flex gap-2 items-center">
                                                ...
                                                <input id="informasiNewFieldLabel" placeholder="Label (contoh: NAMA)"
                                                    class="px-3 py-2 border rounded" />
                                                <input id="informasiNewFieldKey" placeholder="Key (contoh: NAMA)"
                                                    class="px-3 py-2 border rounded w-36" />
                                                <input id="informasiNewFieldOptions"
                                                    placeholder="Options (jika select, gunakan , pemisah)"
                                                    class="px-3 py-2 border rounded w-64" />
                                                <label class="inline-flex items-center gap-2 text-sm text-gray-700">
                                                    <input id="informasiNewFieldRequired" type="checkbox"
                                                        class="h-4 w-4 border-gray-300 rounded" /> <span>Wajib</span>
                                                </label>
                                            </div>
                                            <div class="flex gap-2 mt-2">
                                                <button id="addInformasiFieldBtn" type="button"
                                                    class="px-3 py-2 bg-green-600 text-white rounded">Tambah</button>
                                                <button id="cancelInformasiFieldBtn" type="button"
                                                    class="px-3 py-2 bg-white border rounded">Batal</button>
                                            </div>
                                        </div>
                            ...
                            <div class="bg-white border border-gray-200 rounded-xl p-6">
                                ...
                                <div id="sectionsEditor"
                                    class="space-y-3 bg-gradient-to-b from-gray-50 to-white p-4 border-2 border-dashed border-gray-300 rounded-lg max-h-96 overflow-y-auto mb-3">
                                    <p class="text-xs text-gray-500 text-center py-8">Belum ada section. Klik tombol di
                                        bawah.</p>
                                </div>
                            ...
                            <!-- Template Fields -->
                            <div id="suratTemplateFields" class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                            </div>
                            <div id="templateDynamicForm" class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                            </div>
                        ...
                        <div class="flex flex-col space-y-4">
                            <div class="bg-white border border-gray-200 rounded-xl p-6 flex-1 flex flex-col">
                                ...
                                <div id="suratPreview"
                                    class="flex-1 bg-white p-4 border border-gray-200 rounded-lg overflow-auto text-sm text-gray-800 shadow-inner font-serif">
                                    <p class="text-xs text-gray-400 text-center py-12">Preview akan muncul saat Anda
                                        mengisi form...</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-3 flex-wrap">
                                <button type="button" id="previewLetterBtn" onclick="previewLetter()"
                                    class="flex-1 px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-semibold">👁️
                                    Pratayang Penuh</button>
                            ...
                            <div class="flex gap-3">
                                <button type="button" id="saveTemplateConfirm"
                                    class="flex-1 px-4 py-3 bg-amber-600 text-white rounded-lg hover:bg-amber-700 transition font-semibold">💾
