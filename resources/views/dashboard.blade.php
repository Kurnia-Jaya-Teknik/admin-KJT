    ...
    <div class="flex min-h-[calc(100vh-130px)]">
        ...
        <div class="flex-1 p-8 bg-gray-50/50">
            ...
            <div
                ...
                @if (session('status'))
                    <div class="mb-4 font-medium text-sm text-white bg-white/10 p-3 rounded-lg border border-white/20">
                        {{ session('status') }}</div>
                @endif
                ...
                @if (Auth::user()->role === 'direktur')
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span
                                class="text-xs font-medium text-green-600 bg-green-100 px-2 py-1 rounded-full">{{ $persentaseKehadiran }}%</span>
                        </div>
                        <h3 class="text-2xl font-bold text-gray-800 mb-1">{{ $persentaseKehadiran }}%</h3>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span
                                class="text-xs font-medium text-red-600 bg-red-100 px-2 py-1 rounded-full">{{ $pendingApprovals }}</span>
                        </div>
                        <h3 class="text-2xl font-bold text-gray-800 mb-1">{{ $pendingApprovals }}</h3>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span
                                class="text-xs font-medium text-purple-600 bg-purple-100 px-2 py-1 rounded-full">{{ $suratDiterbitkan }}</span>
                        </div>
                        <h3 class="text-2xl font-bold text-gray-800 mb-1">{{ $suratDiterbitkan }}</h3>
                ...
                @elseif(Auth::user()->role === 'admin_hrd')
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span
                                class="text-xs font-medium text-green-600 bg-green-100 px-2 py-1 rounded-full">{{ round(($hadirHariIni / $totalKaryawan) * 100) }}%</span>
                        </div>
                        <h3 class="text-2xl font-bold text-gray-800 mb-1">{{ $hadirHariIni }}</h3>
                    ...
                    <div
                        ...
                        <h3 class="text-2xl font-bold text-gray-800 mb-1">{{ $pengajuanDisetujui }}</h3>
                    ...
                    <div
                        ...
                        <h3 class="text-2xl font-bold text-gray-800 mb-1">{{ $suratSiapDikirim }}</h3>
                ...
                @else
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span
                                class="text-xs font-medium text-green-600 bg-green-100 px-2 py-1 rounded-full">{{ $statusAbsensi }}</span>
                        </div>
                        <h3 class="text-2xl font-bold text-gray-800 mb-1">{{ $statusAbsensi }}</h3>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span
                                class="text-xs font-medium text-amber-600 bg-amber-100 px-2 py-1 rounded-full">2026</span>
                        </div>
                        <h3 class="text-2xl font-bold text-gray-800 mb-1">{{ $sisaCuti }} Hari</h3>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span
                                class="text-xs font-medium text-green-600 bg-green-100 px-2 py-1 rounded-full">{{ $pengajuanDisetujui }}</span>
                        </div>
                        <h3 class="text-2xl font-bold text-gray-800 mb-1">{{ $pengajuanDisetujui }}</h3>
                        <p class="text-sm text-gray-500">Pengajuan Disetujui</p>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span
                                class="text-xs font-medium text-purple-600 bg-purple-100 px-2 py-1 rounded-full">{{ $statusKontrak }}</span>
                        </div>
                        <h3 class="text-2xl font-bold text-gray-800 mb-1">{{ $statusKontrak }}</h3>
                            ...
                            <div class="h-64 flex items-end justify-center gap-2 px-2">
                                <div class="w-full h-full flex flex-col items-end justify-end">
                                    <svg class="w-full h-full" viewBox="0 0 500 250" preserveAspectRatio="none">
                                        <polyline
                                            points="10,150 70,120 130,140 190,100 250,130 310,90 370,110 430,80 490,100"
                                        ...
                                        <text x="10" y="225" font-size="12" fill="#6b7280"
                                            text-anchor="middle">Jan</text>
                                        <text x="70" y="225" font-size="12" fill="#6b7280"
                                            text-anchor="middle">Feb</text>
                                        <text x="130" y="225" font-size="12" fill="#6b7280"
                                            text-anchor="middle">Mar</text>
                                        <text x="190" y="225" font-size="12" fill="#6b7280"
                                            text-anchor="middle">Apr</text>
                                        <text x="250" y="225" font-size="12" fill="#6b7280"
                                            text-anchor="middle">Mei</text>
                                        <text x="310" y="225" font-size="12" fill="#6b7280"
                                            text-anchor="middle">Jun</text>
                                        <text x="370" y="225" font-size="12" fill="#6b7280"
                                            text-anchor="middle">Jul</text>
                                        <text x="430" y="225" font-size="12" fill="#6b7280"
                                            text-anchor="middle">Agu</text>
                                        <text x="490" y="225" font-size="12" fill="#6b7280"
                                            text-anchor="middle">Sep</text>
                                    </svg>
                                </div>
                            </div>
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                            ...
                            <div class="h-48 flex items-center justify-center relative">
                                <svg class="w-40 h-40" viewBox="0 0 120 120">
                                    <circle cx="60" cy="60" r="50" fill="none" stroke="#3b82f6"
                                        stroke-width="12" stroke-dasharray="78.5 314"
                                        transform="rotate(-90 60 60)" />
                                    <circle cx="60" cy="60" r="50" fill="none" stroke="#f59e0b"
                                        stroke-width="12" stroke-dasharray="62.8 314" stroke-dashoffset="-78.5"
                                        transform="rotate(-90 60 60)" />
                                    <circle cx="60" cy="60" r="50" fill="none" stroke="#8b5cf6"
                                        stroke-width="12" stroke-dasharray="47.1 314" stroke-dashoffset="-141.3"
                                        transform="rotate(-90 60 60)" />
                            ...
                            <div class="mt-4 space-y-2 text-sm">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="font-medium text-gray-800">{{ $statusKaryawan['PKWTT'] ?? 0 }}</span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                    ...
                                    <span class="font-medium text-gray-800">{{ $statusKaryawan['PKWT'] ?? 0 }}</span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                    ...
                                    <span
                                        class="font-medium text-gray-800">{{ $statusKaryawan['Magang'] ?? 0 }}</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-3">
                                <div>
                                    <div class="flex items-center justify-between mb-1">
                                        ...
                                        <span
                                            class="text-sm font-semibold text-gray-800">{{ $jenisSurat['Surat Rekomendasi'] ?? 0 }}</span>
                                    </div>
                                    <div class="w-full bg-gray-100 rounded-full h-2">
                                        <div class="bg-blue-500 h-2 rounded-full"
                                            style="width: {{ $suratDiterbitkan > 0 ? round((($jenisSurat['Surat Rekomendasi'] ?? 0) / $suratDiterbitkan) * 100) : 0 }}%">
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <div class="flex items-center justify-between mb-1">
                                        ...
                                        <span
                                            class="text-sm font-semibold text-gray-800">{{ $jenisSurat['Surat Keterangan'] ?? 0 }}</span>
                                    </div>
                                    <div class="w-full bg-gray-100 rounded-full h-2">
                                        <div class="bg-green-500 h-2 rounded-full"
                                            style="width: {{ $suratDiterbitkan > 0 ? round((($jenisSurat['Surat Keterangan'] ?? 0) / $suratDiterbitkan) * 100) : 0 }}%">
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <div class="flex items-center justify-between mb-1">
                                        ...
                                        <span
                                            class="text-sm font-semibold text-gray-800">{{ $jenisSurat['Surat Tanggung Jawab'] ?? 0 }}</span>
                                    </div>
                                    <div class="w-full bg-gray-100 rounded-full h-2">
                                        <div class="bg-amber-500 h-2 rounded-full"
                                            style="width: {{ $suratDiterbitkan > 0 ? round((($jenisSurat['Surat Tanggung Jawab'] ?? 0) / $suratDiterbitkan) * 100) : 0 }}%">
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <div class="flex items-center justify-between mb-1">
                                        ...
                                        <span
                                            class="text-sm font-semibold text-gray-800">{{ $jenisSurat['Surat Lainnya'] ?? 0 }}</span>
                                    </div>
                                    <div class="w-full bg-gray-100 rounded-full h-2">
                                        <div class="bg-purple-500 h-2 rounded-full"
                                            style="width: {{ $suratDiterbitkan > 0 ? round((($jenisSurat['Surat Lainnya'] ?? 0) / $suratDiterbitkan) * 100) : 0 }}%">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            @if (Auth::user()->role === 'direktur')
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 mb-8">
                    ...
                    <div class="overflow-x-auto">
                        <div x-data="{ open: false, action: '', mode: '', reason: '', isSubmitting: false }">
                            <table class="w-full">
                                <thead>
                                    ...
                                    @forelse($pengajuanMenunggu as $pengajuan)
                                        <tr class="hover:bg-gray-50/50 transition-colors">
                                            ...
                                            <td class="px-6 py-4 text-center text-sm text-gray-600">
                                                ...
                                                @if (str_contains($pengajuan['jenis'], 'Cuti')) bg-blue-100 text-blue-800 
                                                @else bg-purple-100 text-purple-800 @endif">
                                                    {{ $pengajuan['jenis'] }}
                                                </span>
                                            </td>
                                            <td class="px-6 py-4 text-center text-sm text-gray-600">{{ $pengajuan['durasi'] }}
                                            </td>
                                            <td class="px-6 py-4 text-center text-sm text-gray-600">{{ $pengajuan['tanggal'] }}
                                            </td>
                                            <td class="px-6 py-4 text-center">
                                                <button type="button"
                                                    @click="action='{{ route('pengajuan.approve', ['type' => $pengajuan['type'], 'id' => $pengajuan['id']]) }}'; mode='approve'; open=true"
                                                    style="display: inline-block !important; margin-right: 8px; padding: 8px 16px; background-color: #16a34a !important; color: white !important; font-size: 11px; font-weight: bold; border-radius: 4px; border: none; cursor: pointer; text-transform: uppercase; opacity: 1 !important; visibility: visible !important; z-index: 10;">
                                                    SETUJUI
                                                </button>
                                                <button type="button"
                                                    @click="action='{{ route('pengajuan.reject', ['type' => $pengajuan['type'], 'id' => $pengajuan['id']]) }}'; mode='reject'; reason=''; open=true"
                                                    style="display: inline-block !important; padding: 8px 16px; background-color: #dc2626 !important; color: white !important; font-size: 11px; font-weight: bold; border-radius: 4px; border: none; cursor: pointer; text-transform: uppercase;">
                                                    TOLAK
                                                </button>
                                            </td>
                                        </tr>
                            ...
                            <template x-teleport="body">
                                <div x-show="open" 
                                    ...
                                    <!-- Modal Box - Centered -->
                                    <div @click.stop
                                        style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background: white; border-radius: 8px; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25); width: 400px; max-width: calc(100% - 32px);">
                                        
                                        <form :action="action" method="POST" @submit="isSubmitting = true">
                                            @csrf
                                            ...
                                            <div style="padding: 16px 20px; border-bottom: 1px solid #e5e7eb;">
                                                <div style="display: flex; align-items: center; justify-content: space-between;">
                                                    <h3 style="font-size: 16px; font-weight: 600; color: #111827; margin: 0;" 
                                                        x-text="mode==='approve' ? 'Konfirmasi Persetujuan' : 'Konfirmasi Penolakan'"></h3>
                                            ...
                                            <div style="padding: 20px;">
                                                ...
                                                <template x-if="mode==='approve'">
                                                    <div style="display: flex; align-items: flex-start; gap: 12px;">
                                                        <svg style="width: 24px; height: 24px; color: #16a34a; flex-shrink: 0;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                                        </svg>
                                                        <p style="font-size: 14px; color: #374151; margin: 0;">Apakah Anda yakin ingin menyetujui pengajuan ini?</p>
                                                    </div>
                                                </template>
                                                ...
                                                <template x-if="mode==='reject'">
                                                    <div>
                                                        <div style="display: flex; align-items: flex-start; gap: 12px; margin-bottom: 16px;">
                                                            ...
                                                            <p style="font-size: 14px; color: #374151; margin: 0;">Apakah Anda yakin ingin menolak pengajuan ini?</p>
                                                        </div>
                                                        <div>
                                                            <label style="display: block; font-size: 14px; font-weight: 500; color: #374151; margin-bottom: 8px;">
                                                                Alasan Penolakan <span style="color: #9ca3af; font-weight: 400;">(opsional)</span>
                                                            </label>
                                                            <textarea 
                                                                name="keterangan" 
                                                                x-model="reason"
                                                                ...
                                                                style="width: 100%; padding: 8px 12px; border: 1px solid #d1d5db; border-radius: 6px; font-size: 14px; resize: none; box-sizing: border-box;"></textarea>
                                                        </div>
                                                    </div>
                                                </template>
                                            </div>
                                            ...
                                            <!-- Footer -->
                                            <div style="padding: 16px 20px; background-color: #f9fafb; border-top: 1px solid #e5e7eb; display: flex; justify-content: flex-end; gap: 12px;">
                                                <button type="button" 
                                                    @click="open = false; reason = '';"
                                                    :disabled="isSubmitting"
                                                    style="padding: 8px 16px; background-color: white; border: 1px solid #d1d5db; border-radius: 6px; font-size: 14px; font-weight: 500; color: #374151; cursor: pointer;">
                                                    Batal
                                                </button>
                                                ...
                                                <template x-if="mode==='approve'">
                                                    <button type="submit" 
                                                        :disabled="isSubmitting"
                                                        style="padding: 8px 16px; background-color: #16a34a !important; border: none; border-radius: 6px; font-size: 14px; font-weight: 500; color: white !important; cursor: pointer; display: inline-block !important; visibility: visible !important;">
                                                        <span x-text="isSubmitting ? 'Memproses...' : 'Ya, Setujui'"></span>
                                                    </button>
                                                </template>
                                                ...
                                                <template x-if="mode==='reject'">
                                                    <button type="submit" 
                                                        :disabled="isSubmitting"
                                                        style="padding: 8px 16px; background-color: #dc2626 !important; border: none; border-radius: 6px; font-size: 14px; font-weight: 500; color: white !important; cursor: pointer; display: inline-block !important; visibility: visible !important;">
                                                        <span x-text="isSubmitting ? 'Memproses...' : 'Ya, Tolak'"></span>
                                                    </button>
                                                </template>
                                            </div>
                                        </form>
                        ...
                        @if (Auth::user()->role === 'direktur')
                            ...
                            <div class="px-6 py-4 hover:bg-gray-50/50 transition-colors">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-gray-500">Surat untuk Siti Nurhaliza - Keterangan revisi
                                            diperlukan</p>
                                    </div>
                            ...
                            <div class="px-6 py-4 hover:bg-gray-50/50 transition-colors">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-sm font-medium text-gray-800">Laporan kehadiran bulan Desember
                                            tersedia</p>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            @if (Auth::user()->role === 'direktur')
                                <button
                                    class="flex flex-col items-center justify-center p-4 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50 hover:from-blue-100 hover:to-indigo-100 transition-all duration-200 group">
                                    <div
                                        class="w-10 h-10 rounded-lg bg-blue-500 flex items-center justify-center mb-2 group-hover:scale-110 transition-transform">
                                ...
                                <button
                                    class="flex flex-col items-center justify-center p-4 rounded-xl bg-gradient-to-br from-purple-50 to-violet-50 hover:from-purple-100 hover:to-violet-100 transition-all duration-200 group">
                                    <div
                                        class="w-10 h-10 rounded-lg bg-purple-500 flex items-center justify-center mb-2 group-hover:scale-110 transition-transform">
                                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                ...
                                <button
                                    class="flex flex-col items-center justify-center p-4 rounded-xl bg-gradient-to-br from-red-50 to-orange-50 hover:from-red-100 hover:to-orange-100 transition-all duration-200 group">
                                    <div
                                        class="w-10 h-10 rounded-lg bg-red-500 flex items-center justify-center mb-2 group-hover:scale-110 transition-transform">
                                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v12a2 2 0 01-2 2h-3l-4 4z" />
                                ...
                                <button
                                    class="flex flex-col items-center justify-center p-4 rounded-xl bg-gradient-to-br from-amber-50 to-orange-50 hover:from-amber-100 hover:to-orange-100 transition-all duration-200 group">
                                    <div
                                        class="w-10 h-10 rounded-lg bg-amber-500 flex items-center justify-center mb-2 group-hover:scale-110 transition-transform">
                                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                            ...
                            @else
                                ...
                                <button
                                    class="flex flex-col items-center justify-center p-4 rounded-xl bg-gradient-to-br from-green-50 to-emerald-50 hover:from-green-100 hover:to-emerald-100 transition-all duration-200 group">
                                    <div
                                        class="w-10 h-10 rounded-lg bg-green-500 flex items-center justify-center mb-2 group-hover:scale-110 transition-transform">
                                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
