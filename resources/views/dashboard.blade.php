                    ...
                    <div class="relative flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                @php
                                    $roleLabel =
                                        Auth::user()->role === 'admin_hrd' ? 'Admin HRD' : ucfirst(Auth::user()->role);
                                @endphp
                                <p class="text-slate-50 text-sm font-semibold">{{ $roleLabel }} @if (Auth::user()->departemen)
                            ...
                            <div>
                                ...
                                @php
                                    $roleLabel =
                                        Auth::user()->role === 'admin_hrd' ? 'Admin HRD' : ucfirst(Auth::user()->role);
                                @endphp
                                <p class="text-red-50/90 text-sm font-semibold">{{ $roleLabel }} @if (Auth::user()->departemen)
                                        • {{ Auth::user()->departemen->nama }}
                                    @endif
                                </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                @if (Auth::user()->role === 'direktur')
                    ...
                    <div
                        ...
                        <div class="relative">
                            ...
                            <h3 class="text-2xl font-bold text-gray-800 mb-0.5">{{ $suratDikirimBulan }}</h3>
                    ...
                    <div
                        ...
                        <div class="relative">
                            ...
                            <h3 class="text-2xl font-bold text-gray-800 mb-0.5">{{ $tindakanDiperlukan }}</h3>
                ...
                @elseif(Auth::user()->role === 'admin_hrd')
                    ...
                    <div
                        ...
                        <div class="relative">
                            ...
                            <h3 class="text-2xl font-bold text-gray-800 mb-0.5">{{ $suratSiapDikirim }}</h3>
                ...
                @else
                    ...
                    <div
                        ...
                        <h3 class="text-2xl font-semibold text-gray-800 mb-1">{{ $sisaCuti }}</h3>
                    ...
                    <div
                        ...
                        <h3 class="text-2xl font-semibold text-gray-800 mb-1">{{ $cutiDipakai }}</h3>
                    ...
                    <div
                        ...
                        <h3 class="text-2xl font-semibold text-gray-800 mb-1">{{ $lemburBulanIni }}</h3>
                    ...
                    <div
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 mb-1">{{ $lastRequestStatus }}</h3>
                            ...
                            <div class="relative">
                                ...
                                <div
                                    ...
                                    @foreach($pengajuanPerBulan as $entry)
                                        @php
                                            $height = $maxPengajuan ? floor(($entry['count'] / $maxPengajuan) * 110) : 20;
                                        @endphp
                                        <div class="flex-1 flex flex-col items-center gap-2 group/bar relative">
                                            ...
                                            <span class="text-xs text-gray-600 font-medium">{{ $entry['label'] }}</span>
                                        </div>
                                    @endforeach
                                </div>
                                <div class="pt-4">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span
                                            class="text-lg font-bold bg-gradient-to-r from-rose-500 to-rose-400 bg-clip-text text-transparent">{{ number_format($totalPengajuan6) }}
                                            pengajuan</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="relative">
                                ...
                                <div class="space-y-5">
                                    <div>
                                        <div class="flex items-center justify-between mb-2.5">
                                            ...
                                            <span
                                                class="text-sm font-bold bg-gradient-to-r from-orange-500 to-orange-400 bg-clip-text text-transparent">42
                                                jam</span>
                                        </div>
                                        <div
                                            class="w-full bg-gradient-to-r from-gray-200/40 to-gray-100/30 rounded-full h-3 shadow-sm overflow-hidden">
                                            <div class="bg-gradient-to-r from-orange-400/80 to-orange-300/60 h-3 rounded-full shadow-md transition-all duration-300 hover:shadow-lg"
                                                style="width: 60%"></div>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="flex items-center justify-between mb-2.5">
                                            ...
                                            <span
                                                class="text-sm font-bold bg-gradient-to-r from-blue-500 to-blue-400 bg-clip-text text-transparent">35
                                                jam</span>
                                        </div>
                                        <div
                                            class="w-full bg-gradient-to-r from-gray-200/40 to-gray-100/30 rounded-full h-3 shadow-sm overflow-hidden">
                                            <div class="bg-gradient-to-r from-blue-400/80 to-blue-300/60 h-3 rounded-full shadow-md transition-all duration-300 hover:shadow-lg"
                                                style="width: 50%"></div>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="flex items-center justify-between mb-2.5">
                                            ...
                                            <span
                                                class="text-sm font-bold bg-gradient-to-r from-emerald-500 to-emerald-400 bg-clip-text text-transparent">31
                                                jam</span>
                                        </div>
                                        <div
                                            class="w-full bg-gradient-to-r from-gray-200/40 to-gray-100/30 rounded-full h-3 shadow-sm overflow-hidden">
                                            <div class="bg-gradient-to-r from-emerald-400/80 to-emerald-300/60 h-3 rounded-full shadow-md transition-all duration-300 hover:shadow-lg"
                                                style="width: 44%"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-5 pt-4 border-t border-gray-100/30 flex items-center justify-between">
                                    ...
                                    <span
                                        class="text-lg font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">150
                                        jam</span>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="relative w-48 h-48">
                                        <svg class="w-full h-full drop-shadow-sm" viewBox="0 0 140 140"
                                            ...
                                            <circle cx="70" cy="70" r="55" fill="none"
                                                stroke="#10b981" stroke-width="22" stroke-dasharray="119.3 340.6"
                                                stroke-linecap="round" opacity="0.8" />
                                            <!-- Pending (soft amber) - 70/140 = 50% = 180° -->
                                            <circle cx="70" cy="70" r="55" fill="none"
                                                stroke="#f59e0b" stroke-width="22" stroke-dasharray="136 340.6"
                                                stroke-dashoffset="-119.3" stroke-linecap="round" opacity="0.8" />
                                            <!-- Rejected (soft red) - 10/140 = 7% = 25.2° -->
                                            <circle cx="70" cy="70" r="55" fill="none"
                                                stroke="#ef4444" stroke-width="22" stroke-dasharray="24.4 340.6"
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center justify-between pb-3 border-b border-gray-100">
                                    ...
                                    <span class="font-bold text-lg text-green-600">{{ $persetujuanSelesai }}</span>
                                </div>
                                <div class="flex items-center justify-between pb-3 border-b border-gray-100">
                                    <div class="flex items-center gap-2">
                                        <span class="text-sm text-gray-600 font-bold">Ditolak (Bulan Ini)</span>
                                    </div>
                                    <span class="font-bold text-lg text-red-600">{{ $ditolakBulan }}</span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                        ...
                        <div
                            ...
                            <div class="relative">
                                ...
                                <div class="flex gap-3 items-end border-b-2 border-gray-200/50 pb-4"
                                    ...
                                    <!-- Agustus -->
                                    <div class="flex-1 flex flex-col items-center justify-end gap-2 group/bar">
                                        <div class="w-full bg-gradient-to-t from-blue-400/70 to-blue-300/50 rounded-t-xl shadow-md group-hover/bar:shadow-lg group-hover/bar:from-blue-400/90 group-hover/bar:to-blue-300/70 transition-all duration-300"
                                    ...
                                    <!-- Januari -->
                                    <div class="flex-1 flex flex-col items-center justify-end gap-2 group/bar">
                                        <div class="w-full bg-gradient-to-t from-indigo-400/70 to-indigo-300/50 rounded-t-xl shadow-md group-hover/bar:shadow-lg group-hover/bar:from-indigo-400/90 group-hover/bar:to-indigo-300/70 transition-all duration-300"
                                ...
                                <div class="relative w-40 h-40 flex items-center justify-center">
                                    ...
                                    <div id="statusTotal"
                                        ...
                                        <div class="bg-white rounded-full px-3 py-2 shadow-sm text-center">
                                            <div class="text-lg font-bold text-gray-800 leading-none">{{ $statusTotal }}</div>
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center justify-between pb-3 border-b border-gray-100">
                                    ...
                                    <span class="font-bold text-lg text-blue-600">{{ $suratDiterbitkan }}</span>
                                </div>
                                <div class="flex items-center justify-between pb-3 border-b border-gray-100">
                                    <span class="text-sm text-gray-600">Siap Dikirim</span>
                                    <span class="font-bold text-lg text-purple-600">{{ $suratSiapDikirim }}</span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-sm text-gray-600">Dikirim Bulan Ini</span>
                                    <span class="font-bold text-lg text-green-600">{{ $suratDikirimBulan }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lg:col-span-2 space-y-5">
                        ...
                        <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm border border-gray-100/50 p-6">
                            <div class="flex items-center justify-between mb-5">
                                <h3 class="text-base font-semibold text-gray-800">Kehadiran Saya - {{ now()->locale('id')->isoFormat('MMMM YYYY') }}</h3>
                                <span class="text-xs font-medium text-pink-600 bg-pink-50 px-2.5 py-1 rounded-full">{{ $presentDaysThisMonth }} / {{ $daysInMonth }} Hari</span>
                            </div>
                            <div class="h-48 flex items-end justify-between gap-1 px-1 overflow-x-auto">
                                @foreach($attendanceDays as $d)
                                    <div class="flex-1 flex flex-col items-center gap-1.5 min-w-[20px]">
                                        ...
                                        @endif
                                        <span class="text-xs text-gray-600 font-medium">{{ $d['day'] }}</span>
                                    </div>
                                @endforeach
                                <div class="flex-1 flex flex-col items-center gap-1.5 min-w-[20px]">
                                    <div class="w-full bg-gradient-to-t from-pink-400/80 to-pink-300/60 rounded-t-lg transition-all duration-300 hover:from-pink-500 hover:to-pink-400"
                                        style="height: 100%;" title="Hadir"></div>
                                    <span class="text-xs text-gray-600 font-medium">7</span>
                                </div>
                                <div class="flex-1 flex flex-col items-center gap-1.5 min-w-[20px]">
                                    <div class="w-full bg-gradient-to-t from-yellow-400/70 to-yellow-300/50 rounded-t-lg transition-all duration-300 hover:from-yellow-500 hover:to-yellow-400"
                                        style="height: 50%;" title="Setengah Hari"></div>
                                    ...
                                    <a href="{{ route('direktur.persetujuan-cuti-lembur') }}"
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-600">{{ $pendingApprovals ?? 0 }} pengajuan menunggu</p>
                                            </div>
                                        </div>
