    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" x-data="roleForm()">
            ...
            <div class="mt-4">
                ...
                <select id="role" name="role" required @change="selectedRole = $event.target.value" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
