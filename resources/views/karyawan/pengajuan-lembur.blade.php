    ...
    <div class="flex-1 lg:ml-64 overflow-y-auto h-[calc(100vh-4rem)]">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100/50 overflow-hidden hover:shadow-md transition-shadow duration-300">
                <div class="px-6 py-3.5 border-b border-gray-100/30 bg-gradient-to-r from-purple-50/20 via-blue-50/20 to-indigo-50/15">
                ...
                <div class="p-6">
                    <form class="space-y-5">
                        <!-- Tanggal Lembur -->
                        <div>
                            <label class="block text-xs font-medium text-gray-600 mb-2">Tanggal Lembur</label>
                            <input type="date" class="w-full px-4 py-2.5 bg-white/80 border border-gray-200/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-400/30 focus:border-purple-300/50 transition-all duration-300 text-sm">
                        </div>

                        <!-- Jam Mulai & Selesai -->
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-xs font-medium text-gray-600 mb-2">Jam Mulai</label>
                                <input type="time" class="w-full px-4 py-2.5 bg-white/80 border border-gray-200/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-400/30 focus:border-purple-300/50 transition-all duration-300 text-sm">
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-600 mb-2">Jam Selesai</label>
                                <input type="time" class="w-full px-4 py-2.5 bg-white/80 border border-gray-200/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-400/30 focus:border-purple-300/50 transition-all duration-300 text-sm">
                            </div>
                        </div>
                        ...
                        <!-- Total Jam -->
                        <div>
                            <label class="block text-xs font-medium text-gray-600 mb-2">Total Jam Lembur</label>
                            <div class="px-4 py-2.5 bg-gradient-to-r from-purple-50/40 to-indigo-50/30 border border-purple-200/30 rounded-xl">
                        ...
                        <div>
                            <label class="block text-xs font-medium text-gray-600 mb-2">Keterangan Pekerjaan</label>
                            <textarea rows="4" placeholder="Jelaskan pekerjaan apa yang akan dilakukan selama lembur..." class="w-full px-4 py-2.5 bg-white/80 border border-gray-200/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-400/30 focus:border-purple-300/50 transition-all duration-300 text-sm resize-none"></textarea>
                        </div>

                        <!-- Info -->
                        <div class="bg-gradient-to-r from-blue-50/40 to-purple-50/30 border border-blue-200/30 rounded-xl p-4">
                        ...
                        <div class="flex gap-3 pt-2">
                            <button type="submit" class="flex-1 px-4 py-2.5 bg-gradient-to-r from-purple-500 to-purple-400 text-white font-medium rounded-xl hover:from-purple-600 hover:to-purple-500 shadow-sm hover:shadow-md transition-all duration-300 text-sm">
                                Ajukan Lembur
                            </button>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100/50 overflow-hidden hover:shadow-md transition-shadow duration-300">
                <div class="px-6 py-3.5 border-b border-gray-100/30 bg-gradient-to-r from-purple-50/20 to-indigo-50/20">
                ...
                <div class="p-6 space-y-5">
                    <div>
                        ...
                        <p class="text-2xl font-semibold bg-gradient-to-r from-purple-500/80 to-purple-400/70 bg-clip-text text-transparent">12 jam</p>
                    ...
                    <div class="border-t border-gray-100/50 pt-5">
                        ...
                        <ul class="space-y-2.5 text-xs text-gray-600">
                            <li class="flex items-start gap-2.5">
                                <div class="w-1.5 h-1.5 rounded-full bg-purple-400/60 mt-1.5 flex-shrink-0"></div>
