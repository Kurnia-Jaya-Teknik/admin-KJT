<x-app-layout>
    ...
    <div class="flex-1 lg:ml-64 overflow-y-auto h-[calc(100vh-4rem)]">
        <div class="p-6 lg:pr-8 lg:pl-4 lg:py-8 bg-gradient-to-br from-slate-50/80 via-slate-50/20 to-red-50/10 min-h-full">
        <!-- Welcome Header -->
        <div class="mb-6">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 p-6 border border-gray-100/50 hover:-translate-y-0.5">
                <div class="flex items-start justify-between mb-4">
                    <div class="flex-1">
                        ...
                        <p class="text-2xl font-semibold bg-gradient-to-r from-red-500/80 to-red-400/70 bg-clip-text text-transparent">8</p>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 p-6 border border-gray-100/50 hover:-translate-y-0.5">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-2xl font-semibold bg-gradient-to-r from-slate-500/80 to-slate-400/70 bg-clip-text text-transparent">4</p>
                    ...
                    <div class="p-2.5 bg-gradient-to-br from-slate-50/60 to-slate-50/40 rounded-xl shadow-sm">
                        <svg class="w-5 h-5 text-slate-500/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 p-6 border border-gray-100/50 hover:-translate-y-0.5">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-2xl font-semibold bg-gradient-to-r from-slate-500/80 to-slate-400/70 bg-clip-text text-transparent">6</p>
                        <p class="text-xs text-gray-500 mt-0.5">tahun ini</p>
                    </div>
                    <div class="p-2.5 bg-gradient-to-br from-slate-50/60 to-slate-50/40 rounded-xl shadow-sm">
                        <svg class="w-5 h-5 text-slate-500/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="lg:col-span-2 bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100/50 overflow-hidden hover:shadow-md transition-shadow duration-300">
                <div class="px-6 py-3.5 border-b border-gray-100/30 bg-gradient-to-r from-red-50/20 via-slate-50/20 to-red-50/15">
                ...
                <div class="divide-y divide-gray-100/50">
                    ...
                    <div class="px-6 py-4 hover:bg-gradient-to-r hover:from-slate-50/30 hover:to-transparent transition-all duration-300 group">
                        <div class="flex items-start gap-3 mb-2">
                            <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-slate-50/60 to-slate-50/40 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300 shadow-sm">
                                <svg class="w-5 h-5 text-slate-500/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100/50 overflow-hidden hover:shadow-md transition-shadow duration-300">
                ...
                <div class="divide-y divide-gray-100/50">
                    ...
                    <div class="px-6 py-4 hover:bg-gradient-to-r hover:from-green-50/30 hover:to-transparent transition-all duration-300 group">
                        <div class="flex gap-3 items-start">
                            <div class="text-center min-w-[50px]">
                                <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-green-50/60 to-green-50/40 flex flex-col items-center justify-center shadow-sm group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div class="px-6 py-4 hover:bg-gradient-to-r hover:from-red-50/30 hover:to-transparent transition-all duration-300 group">
                        <div class="flex gap-3 items-start">
                            <div class="text-center min-w-[50px]">
                                <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-red-50/60 to-red-50/40 flex flex-col items-center justify-center shadow-sm group-hover:scale-110 transition-transform duration-300">
                ...
                <div class="px-6 py-3 bg-gray-50/50 border-t border-gray-100/50 text-center">
                    <a href="{{ route('karyawan.riwayat') }}" class="text-xs font-medium text-red-600 hover:text-red-700 transition-colors inline-flex items-center gap-1">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            <a href="{{ route('karyawan.pengajuan-cuti') }}" class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100/50 p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
                <div class="flex items-start gap-3">
                    <div class="p-3 bg-gradient-to-br from-red-50/60 to-red-50/40 rounded-xl group-hover:scale-110 transition-transform duration-300 shadow-sm">
                        <svg class="w-6 h-6 text-red-500/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                    </div>
                    <div class="flex-1">
                        <p class="text-sm font-semibold text-gray-800 group-hover:text-red-500/80 transition-colors mb-0.5">Ajukan Cuti</p>
                        <p class="text-xs text-gray-500">Cuti tahunan, sakit, atau khusus</p>
                    </div>
                    <svg class="w-4 h-4 text-gray-400 group-hover:text-red-500/80 transition-colors mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                    </svg>
                </div>
            </a>
            ...
            <a href="{{ route('karyawan.pengajuan-lembur') }}" class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100/50 p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
                <div class="flex items-start gap-3">
                    <div class="p-3 bg-gradient-to-br from-slate-50/60 to-slate-50/40 rounded-xl group-hover:scale-110 transition-transform duration-300 shadow-sm">
                        <svg class="w-6 h-6 text-slate-500/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                    </div>
                    <div class="flex-1">
                        <p class="text-sm font-semibold text-gray-800 group-hover:text-slate-500/80 transition-colors mb-0.5">Ajukan Lembur</p>
                        <p class="text-xs text-gray-500">Jam kerja tambahan</p>
                    </div>
                    <svg class="w-4 h-4 text-gray-400 group-hover:text-slate-500/80 transition-colors mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                    </svg>
                </div>
            </a>
            ...
            <a href="{{ route('karyawan.surat') }}" class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100/50 p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
                <div class="flex items-start gap-3">
                    <div class="p-3 bg-gradient-to-br from-green-50/60 to-green-50/40 rounded-xl group-hover:scale-110 transition-transform duration-300 shadow-sm">
                        <svg class="w-6 h-6 text-green-500/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                        </svg>
                    </div>
                    <div class="flex-1">
                        <p class="text-sm font-semibold text-gray-800 group-hover:text-green-500/80 transition-colors mb-0.5">Ajukan Surat</p>
                        <p class="text-xs text-gray-500">PKWT, PKWTT, atau lainnya</p>
                    </div>
                    <svg class="w-4 h-4 text-gray-400 group-hover:text-green-500/80 transition-colors mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                    </svg>
                </div>
            </a>
