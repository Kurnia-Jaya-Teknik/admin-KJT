<x-app-layout>
    ...
    <div class="flex-1 lg:ml-64 overflow-y-auto h-[calc(100vh-4rem)]">
        <div
            ...
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-500">Ajukan ijin sakit dan lampirkan bukti (opsional).</p>
            </div>
    ...
    @push('scripts')
        <script>
            // Attendance scripts removed — page converted to Ijin Sakit
            console.info('Ijin Sakit page loaded — attendance scripts removed');
        </script>
    @endpush
