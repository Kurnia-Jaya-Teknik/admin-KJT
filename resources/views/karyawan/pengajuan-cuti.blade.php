<x-app-layout>
    ...
    <div class="flex-1 lg:ml-64 overflow-y-auto h-[calc(100vh-4rem)]">
        <div class="p-6 lg:pr-8 lg:pl-4 lg:py-8 bg-gradient-to-br from-red-50/80 via-slate-50/20 to-red-50/10 min-h-full">
        <!-- Welcome Header -->
        <div class="mb-6">
                ...
                <div class="p-6">
                    <form class="space-y-5">
                        ...
                        <div>
                            ...
                            <select class="w-full px-4 py-2.5 bg-white/70 border border-gray-200/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-400/40 focus:border-red-300/60 transition-all duration-300 text-sm text-gray-700">
                        ...
                        <div>
                            ...
                            <textarea rows="4" placeholder="Jelaskan alasan pengajuan cuti Anda..." class="w-full px-4 py-2.5 bg-white/70 border border-gray-200/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-400/40 focus:border-red-300/60 transition-all duration-300 text-sm resize-none text-gray-700 placeholder-gray-400"></textarea>
                        </div>

                        <!-- Info -->
                        <div class="bg-gradient-to-r from-red-50/40 to-slate-50/30 border border-red-200/30 rounded-xl p-4">
                            <div class="flex items-start gap-3">
                                ...
                                <p class="text-xs text-gray-600 leading-relaxed">
                                    <span class="font-medium text-gray-700">Catatan:</span> Sisa cuti tahunan Anda <strong class="text-red-600/80">8 hari</strong>. Pastikan pengajuan tidak melebihi jumlah sisa cuti.
                                </p>
                            </div>
                        </div>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100/50 overflow-hidden hover:shadow-md transition-shadow duration-300">
                ...
                <div class="p-6 space-y-5">
                    <div>
                        ...
                        <p class="text-2xl font-semibold bg-gradient-to-r from-red-500/80 to-red-400/70 bg-clip-text text-transparent">8 hari</p>
                ...
                <div class="px-6 py-4 hover:bg-gradient-to-r hover:from-green-50/30 hover:to-transparent transition-all duration-300 group">
                    <div class="flex items-start gap-3 mb-2">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <button class="text-xs text-red-600/90 hover:text-red-700 font-medium transition-colors">Lihat Detail →</button>
                        </div>
                    </div>
                </div>
