                ...
                <div class="lg:col-span-2 bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6">
                        <form class="space-y-6">
                            ...
                            <!-- Keterangan Tambahan -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Keterangan Tambahan
                                    (Opsional)</label>
                                <textarea rows="3" placeholder="Tambahkan keterangan jika diperlukan..."
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"></textarea>
                            </div>

                            <!-- Info -->
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                <p class="text-sm text-blue-800">
                                    <span class="font-medium">Catatan:</span> Surat akan diproses dalam waktu 1-2 hari
                                    kerja. Anda akan diberitahu melalui notifikasi ketika surat sudah siap diambil.
                                </p>
                            </div>
                ...
                <div class="divide-y divide-gray-200">
                    ...
                    <div class="p-6 hover:bg-gray-50 transition-colors">
                        <div class="flex items-start justify-between mb-3">
                            ...
                            <span class="px-3 py-1 bg-green-100 text-green-800 text-xs font-medium rounded-full">Siap
                                Ambil</span>
                        </div>
                    ...
                    <div class="p-6 hover:bg-gray-50 transition-colors">
                        <div class="flex items-start justify-between mb-3">
                            ...
                            <span
                                class="px-3 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded-full">Diproses</span>
                        </div>
