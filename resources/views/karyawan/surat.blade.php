<x-app-layout>
    ...
    <div class="flex-1 lg:ml-64 overflow-y-auto h-[calc(100vh-4rem)]">
        <div class="p-6 lg:pr-8 lg:pl-4 lg:py-8 bg-gradient-to-br from-slate-50/80 via-slate-50/20 to-green-50/10 min-h-full">
        <!-- Welcome Header -->
        <div class="mb-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-white/90 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-100/40 overflow-hidden hover:shadow-md transition-all duration-300">
                <div class="px-6 py-3.5 border-b border-gray-100/30 bg-gradient-to-r from-green-50/20 via-slate-50/20 to-slate-50/15">
                ...
                <div class="p-6">
                    <form class="space-y-5">
                            ...
                            <!-- Keterangan Tambahan -->
                            <div>
                                <label class="block text-xs font-medium text-gray-700 mb-2.5">Keterangan Tambahan (Opsional)</label>
                            ...
                            <!-- Info -->
                            <div class="bg-gradient-to-r from-green-50/40 to-slate-50/30 border border-green-200/30 rounded-xl p-4">
                                <div class="flex items-start gap-3">
                                    <div class="p-1.5 bg-green-100/50 rounded-lg flex-shrink-0 mt-0.5">
                                        <svg class="w-4 h-4 text-green-500/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex items-start gap-3 mb-2">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-start justify-between mb-1.5">
                                    ...
                                    <span class="px-2.5 py-0.5 bg-slate-50/70 text-slate-600/80 text-xs font-medium rounded-full shadow-sm flex-shrink-0 ml-2">Diproses</span>
                                </div>
