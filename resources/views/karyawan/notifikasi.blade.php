<x-app-layout>
    ...
    <div class="flex-1 lg:ml-64 overflow-y-auto h-[calc(100vh-4rem)]">
        <div class="p-6 lg:pr-8 lg:pl-4 lg:py-8 bg-gray-50/50 min-h-full">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
                <div class="flex items-center justify-between gap-4">
                    <div class="flex gap-2">
                        <button
                            class="px-4 py-2 bg-red-600 text-white font-medium rounded-lg hover:bg-red-700 transition-colors">Semua</button>
                        <button
                            class="px-4 py-2 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition-colors">Belum
                            Dibaca</button>
                        <button
                            class="px-4 py-2 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition-colors">Disetujui</button>
                        <button
                            class="px-4 py-2 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition-colors">Ditolak</button>
                    </div>
                    <button class="text-sm text-red-600 hover:text-red-700 font-medium">Tandai semua sudah
                        dibaca</button>
                </div>
            </div>
            ...
            <div
                class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg shadow-sm border-2 border-green-200 p-5 mb-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-bold text-gray-800 flex items-center gap-2">
                        <span class="text-2xl">📬</span>
                        Surat Keterangan Diterima
                    </h3>
                    <span id="suratKeteranganBadge"
                        class="hidden px-3 py-1.5 text-sm font-bold text-white bg-red-500 rounded-full">0</span>
                </div>
            ...
            <div class="space-y-3">
                        ...
                        <div class="flex-1">
                            <div class="flex items-start justify-between mb-2">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 mt-1">Cuti tahunan 3 hari telah disetujui oleh
                                        Direktur. Cuti akan dilaksanakan pada 10-12 Januari 2026.</p>
                                </div>
                                <div class="flex items-center gap-2 flex-shrink-0">
                                    <span
                                        class="px-2 py-1 bg-green-100 text-green-800 text-xs font-medium rounded">Disetujui</span>
                        ...
                        <div class="flex-1">
                            <div class="flex items-start justify-between mb-2">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 mt-1">Pengajuan lembur 5 jam pada 6 Januari 2026
                                        sedang dalam proses persetujuan oleh Direktur. Anda akan diberitahu segera
                                        setelah ada keputusan.</p>
                                </div>
                                <div class="flex items-center gap-2 flex-shrink-0">
                                    <span
                                        class="px-2 py-1 bg-red-100 text-red-800 text-xs font-medium rounded">Menunggu</span>
                                    <button class="text-gray-400 hover:text-gray-600">×</button>
                                </div>
                            </div>
                ...
                <div
                    class="bg-gray-50 rounded-lg shadow-sm border border-gray-200 p-4 hover:shadow-md transition-shadow cursor-pointer opacity-75">
                    <div class="flex items-start gap-4">
                        <div class="flex-1">
                            <div class="flex items-start justify-between mb-2">
                                <div>
                                    <p class="font-medium text-gray-800">Pengajuan Cuti Ditolak</p>
                                    <p class="text-sm text-gray-600 mt-1">Pengajuan cuti sakit pada 5 Januari 2026 telah
                                        ditolak. Alasan: Bentrok dengan jadwal shift penting. Anda dapat mengajukan
                                        kembali dengan waktu yang berbeda.</p>
                                </div>
                                <div class="flex items-center gap-2 flex-shrink-0">
                                    <span
                                        class="px-2 py-1 bg-red-100 text-red-800 text-xs font-medium rounded">Ditolak</span>
                                    <button class="text-gray-400 hover:text-gray-600">×</button>
                                </div>
                            </div>
                        ...
                        <div class="flex-1">
                            <div class="flex items-start justify-between mb-2">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 mt-1">Surat Keterangan Kerja yang Anda ajukan untuk
                                        keperluan bank sudah siap. Silakan unduh atau ambil di kantor HR.</p>
                                </div>
                                <div class="flex items-center gap-2 flex-shrink-0">
                                    <span
                                        class="px-2 py-1 bg-slate-100 text-slate-800 text-xs font-medium rounded">Siap</span>
                                    <button class="text-gray-400 hover:text-gray-600">×</button>
                                </div>
                            </div>
                        ...
                        <div class="flex-1">
                            <div class="flex items-start justify-between mb-2">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 mt-1">Slip gaji Anda untuk bulan Desember 2025 sudah
                                        tersedia di sistem. Silakan unduh dari menu Profil atau hubungi HR untuk detail.
                                    </p>
                                </div>
                                <div class="flex items-center gap-2 flex-shrink-0">
                                    <span
                                        class="px-2 py-1 bg-slate-100 text-slate-800 text-xs font-medium rounded">Info</span>
                                    <button class="text-gray-400 hover:text-gray-600">×</button>
                                </div>
                            </div>
                        ...
                        <div class="flex-1">
                            <div class="flex items-start justify-between mb-2">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 mt-1">Pengajuan lembur 4 jam pada 2 Januari 2026
                                        telah disetujui oleh Direktur. Terima kasih atas kontribusi kerja Anda.</p>
                                </div>
                                <div class="flex items-center gap-2 flex-shrink-0">
                                    <span
                                        class="px-2 py-1 bg-green-100 text-green-800 text-xs font-medium rounded">Disetujui</span>
                    ...
                    <div class="flex items-start gap-4">
                        <div class="flex-1">
                            <div class="flex items-start justify-between mb-2">
                                <div>
                                    <p class="font-medium text-gray-800">Pengajuan Cuti Disetujui</p>
                                    <p class="text-sm text-gray-600 mt-1">Pengajuan cuti tahunan 5 hari pada 16-20
                                        Desember 2025 telah disetujui oleh Direktur. Nikmati liburanmu dan pulang dengan
                                        aman.</p>
                                </div>
                                <div class="flex items-center gap-2 flex-shrink-0">
                                    <span
